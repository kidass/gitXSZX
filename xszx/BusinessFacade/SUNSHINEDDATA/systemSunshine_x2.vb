...
Namespace Xydc.Platform.BusinessFacade
    ...
    ' 类名    ：systemSunshine_x2
    '
    ' 功能描述： 
    '   　提供对阳光家缘数据的表现层支持
    '----------------------------------------------------------------
    Public Class systemSunshine_x2
        Implements System.IDisposable

        Private m_objrulesSunshine As Xydc.Platform.BusinessRules.rulesSunshine_x2
        ...
        Public Sub New()
            MyBase.New()
            m_objrulesSunshine = New Xydc.Platform.BusinessRules.rulesSunshine_x2
        End Sub

        '----------------------------------------------------------------
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.systemSunshine_x2)
            Try

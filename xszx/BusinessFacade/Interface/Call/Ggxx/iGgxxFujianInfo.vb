...
Namespace Xydc.Platform.BusinessFacade
    ...
    ' 类名    ：IGGXXFlowFujianInfo
    '
    ' 功能描述： 
    '     flow_fujian_info.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IGGXXFlowFujianInfo
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IGGXXFlowFujianInfo)
            Try

...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     dmxz_zzjg.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IDmxzZzjg
        Inherits Xydc.Platform.BusinessFacade.ICallInterface

        '----------------------------------------------------------------
        '输入参数
        '----------------------------------------------------------------
        Private m_strInputList_I As String            '现有部门列表
        ...
        Private m_strOutputList_O As String           '新选择的部门列表,按系统指定的分隔符分隔(CharSeparate)
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IDmxzZzjg)
            Try
        ...
        ' iBumenList属性
        '----------------------------------------------------------------
        Public Property iBumenList() As String
            Get
                iBumenList = m_strInputList_I
            End Get
        ...
        ' oBumenList属性
        '----------------------------------------------------------------
        Public Property oBumenList() As String
            Get
                oBumenList = m_strOutputList_O
            End Get
            Set(ByVal Value As String)
                Try

...
Namespace Xydc.Platform.BusinessFacade
    ...
    ' 类名    ：IQzbjWorkFlowSpxx
    '
    ' 功能描述： 
    '     qzbj_workflow_spxx.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IQzbjWorkFlowSpxx
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IQzbjWorkFlowSpxx)
            Try

...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     flow_byqk.aspx模块调用接口的定义与处理
    '----------------------------------------------------------------
    <Serializable()> Public Class IFlowByqk
        ...
        Private m_strYjjhList_I As String                            '原交接号列表
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IFlowByqk)
            Try
        ...
        ' iYjjhList属性
        '----------------------------------------------------------------
        Public Property iYjjhList() As String
            Get
                iYjjhList = m_strYjjhList_I
            End Get
            Set(ByVal Value As String)
                Try
                    m_strYjjhList_I = Value
                Catch ex As Exception
                    m_strYjjhList_I = ""
                End Try
            End Set

...
Namespace Xydc.Platform.BusinessFacade
    ...
    '----------------------------------------------------------------
    <Serializable()> Public Class IFlowBycl
        ...
        '    2-主动进行补阅
        '    3-综合处理
        Private m_intMode_I As Integer
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Overloads Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IFlowBycl)
            Try

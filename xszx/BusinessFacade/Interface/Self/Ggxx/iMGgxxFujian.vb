...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     Ggxx_fujian.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMGgxxFujian
        ...
        'grdFJ paramters
        '----------------------------------------------------------------
        Private m_objDataSet_FJ As Xydc.Platform.Common.Data.ggxxDianzigonggaoData    '电子公告附件数据
        Private m_objDataSet_FJ_ZCML As Xydc.Platform.Common.Data.ggxxDianzigonggaoData          '资产目录附件数据
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IMGgxxFujian)
            Try
        ...
        '----------------------------------------------------------------
        ' objDataSet_FJ_ZCML属性
        '----------------------------------------------------------------
        Public Property DataSet_FJ_ZCML() As Xydc.Platform.Common.Data.ggxxDianzigonggaoData
            Get
                DataSet_FJ_ZCML = m_objDataSet_FJ_ZCML
            End Get
            Set(ByVal Value As Xydc.Platform.Common.Data.ggxxDianzigonggaoData)
                Try
                    m_objDataSet_FJ_ZCML = Value
                Catch ex As Exception
                    m_objDataSet_FJ_ZCML = Nothing
                End Try
            End Set

...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     ggxx_dzgg_read.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMGgxxDzggRead
        ...
        Private m_intSelectedIndex_ddlDZGGSearch_SFGQ As Integer 'ddlDZGGSearch_SFGQ
        ...
        Public Sub New()
            ...
            m_intSelectedIndex_ddlDZGGSearch_SFGQ = -1
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IMGgxxDzggRead)
            Try
        ...
        '----------------------------------------------------------------
        ' ddlDZGGSearch_SFGQ_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlDZGGSearch_SFGQ_SelectedIndex() As Integer
            Get
                ddlDZGGSearch_SFGQ_SelectedIndex = m_intSelectedIndex_ddlDZGGSearch_SFGQ
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlDZGGSearch_SFGQ = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlDZGGSearch_SFGQ = -1
                End Try
            End Set

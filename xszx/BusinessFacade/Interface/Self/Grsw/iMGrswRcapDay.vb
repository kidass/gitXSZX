...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     grsw_rcap_day.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMGrswRcapDay
        ...
        Private m_strhtxtDay As String                           'htxtDay
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IMGrswRcapDay)
            Try
        ...
        ' htxtDay属性
        '----------------------------------------------------------------
        Public Property htxtDay() As String
            Get
                htxtDay = m_strhtxtDay
            End Get
            Set(ByVal Value As String)
                Try
                    m_strhtxtDay = Value

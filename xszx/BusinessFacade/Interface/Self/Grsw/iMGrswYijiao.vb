...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     grsw_yijiao.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMGrswYijiao
        ...
        Private m_strtxtYJSM As String                            'txtYJSM

        Private m_intSelectedIndex_ddlWJLX As Integer             'ddlWJLX
        Private m_intSelectedIndex_ddlSFYJ As Integer             'ddlSFYJ
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IMGrswYijiao)
            Try
        ...
        ' txtYJSM属性
        '----------------------------------------------------------------
        Public Property txtYJSM() As String
            Get
                txtYJSM = m_strtxtYJSM
            End Get
            Set(ByVal Value As String)
                Try
                    m_strtxtYJSM = Value
        ...
        '----------------------------------------------------------------
        ' ddlSFYJ_SelectedIndex属性
        '----------------------------------------------------------------
        Public Property ddlSFYJ_SelectedIndex() As Integer
            Get
                ddlSFYJ_SelectedIndex = m_intSelectedIndex_ddlSFYJ
            End Get
            Set(ByVal Value As Integer)
                Try
                    m_intSelectedIndex_ddlSFYJ = Value
                Catch ex As Exception
                    m_intSelectedIndex_ddlSFYJ = -1
                End Try
            End Set

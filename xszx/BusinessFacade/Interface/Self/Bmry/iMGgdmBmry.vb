...
Namespace Xydc.Platform.BusinessFacade
    ...
    '
    ' 功能描述： 
    '     ggdm_bmry.aspx模块本身恢复现场需要的信息
    '----------------------------------------------------------------
    <Serializable()> Public Class IMGgdmBmry
        ...
        'treeview - tvwBMLIST
        '----------------------------------------------------------------
        Private m_strSelectedNodeIndex_tvwBMLIST As String
        ...
        Public Sub New()
            ...
            'treeview
            m_strSelectedNodeIndex_tvwBMLIST = ""
        ...
        ' 安全释放本身资源
        '----------------------------------------------------------------
        Public Shared Sub SafeRelease(ByRef obj As Xydc.Platform.BusinessFacade.IMGgdmBmry)
            Try
        ...
        '----------------------------------------------------------------
        ' tvwBMLISTSelectedNodeIndex属性
        '----------------------------------------------------------------
        Public Property tvwBMLISTSelectedNodeIndex() As String
            Get
                tvwBMLISTSelectedNodeIndex = m_strSelectedNodeIndex_tvwBMLIST
            End Get
            Set(ByVal Value As String)
                Try
                    m_strSelectedNodeIndex_tvwBMLIST = Value
                Catch ex As Exception
                    m_strSelectedNodeIndex_tvwBMLIST = ""
                End Try
            End Set

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="xtgl_mkqx_js.aspx.vb" Inherits="Xydc.Platform.web.xtgl_mkqx_js" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>应用系统模块权限管理窗(基于角色管理)</title>
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRoleQX" runat="server" Enabled="False" Font-Size="12px" Font-Name="宋体"><img src="../../images/users.ico" alt="open" border="0" width="16" height="16">角色授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUserQX" runat="server" Font-Size="12px" Font-Name="宋体"><img src="../../images/user.ico" alt="open" border="0" width="16" height="16">用户授权</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLGrant" runat="server" Font-Size="12px" Font-Name="宋体"><img src="../../images/grant.ico" alt="open" border="0" width="16" height="16">授权执行</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRevoke" runat="server" Font-Size="12px" Font-Name="宋体"><img src="../../images/revoke.ico" alt="open" border="0" width="16" height="16">回收权限</asp:linkbutton></TD>
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtSearchMKDM" runat="server" Font-Size="12px" Font-Name="宋体" Height="22px" CssClass="textbox" Columns="20"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;名称&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKMC" runat="server" Font-Size="12px" Font-Name="宋体" Height="22px" CssClass="textbox" Columns="30"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;说明&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchMKSM" runat="server" Font-Size="12px" Font-Name="宋体" Height="22px" CssClass="textbox" Columns="20"></asp:textbox></TD>
											...
											<TR>
												<TD>
													<DIV id="divObject" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 570px; CLIP: rect(0px 570px 410px 0px); HEIGHT: 410px">
														<asp:datagrid id="grdObject" runat="server" Font-Size="12px" CssClass="label" AllowSorting="True"
															UseAccessibleHeader="True" BorderWidth="0px" BorderColor="#DEDFDE" PageSize="30" AllowPaging="True"
															CellPadding="4" BorderStyle="None" BackColor="White" Font-Names="宋体" GridLines="Vertical"

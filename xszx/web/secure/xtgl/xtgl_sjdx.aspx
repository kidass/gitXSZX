<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="xtgl_sjdx.aspx.vb" Inherits="Xydc.Platform.web.xtgl_sjdx" %>
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLAutoReg" runat="server" Font-Size="12px" Font-Name="宋体">自动注册</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLUserReg" runat="server" Font-Size="12px" Font-Name="宋体">手动注册</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLUpdateReg" runat="server" Font-Size="12px" Font-Name="宋体">修改注册</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLDeleteReg" runat="server" Font-Size="12px" Font-Name="宋体">删除注册</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLSelectReg" runat="server" Font-Size="12px" Font-Name="宋体">查看注册</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLUpdateDB" runat="server" Font-Size="12px" Font-Name="宋体">改数据库</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLSelectDB" runat="server" Font-Size="12px" Font-Name="宋体">看数据库</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLUpdateDX" runat="server" Font-Size="12px" Font-Name="宋体">修改对象</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLSelectDX" runat="server" Font-Size="12px" Font-Name="宋体">查看对象</asp:linkbutton></TD>
									<TD vAlign="middle" align="center"><asp:linkbutton id="lnkMLClearData" runat="server" Font-Size="12px" Font-Name="宋体">清理数据</asp:linkbutton></TD>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									...
									<TD vAlign="top" align="left" width="220" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD><IEWC:TREEVIEW id="tvwServers" runat="server" Font-Size="12px" Font-Name="宋体" Height="460px" Width="220px" CssClass="label" AutoPostBack="True"></IEWC:TREEVIEW></TD>
											</TR>
										</TABLE>
									</TD>
									<TD width="5"></TD>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right">对象名&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchDXM" runat="server" Font-Size="12px" CssClass="textbox" Columns="24" Font-Names="宋体" height="22px"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;中文名&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchDXZWM" runat="server" Font-Size="12px" CssClass="textbox" Columns="36" Font-Names="宋体" height="22px"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;说明&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchDXSM" runat="server" Font-Size="12px" CssClass="textbox" Columns="24" Font-Names="宋体" height="22px"></asp:textbox></TD>
															<TD class="label">&nbsp;&nbsp;<asp:button id="btnSearch" Runat="server" Font-Size="12px" Font-Name="宋体" CssClass="button" Text="搜索"></asp:button></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>
											<TR>
												<TD>
													<DIV id="divObject" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 570px; CLIP: rect(0px 570px 410px 0px); HEIGHT: 410px">
														<asp:datagrid id="grdObject" runat="server" Font-Size="12px" Width="740px" CssClass="label" Font-Names="宋体"
												...
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															...
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZGotoPage" runat="server"  CssClass="labelBlack">前往</asp:linkbutton><asp:textbox id="txtPageIndex" runat="server" Font-Size="12px" Font-Name="宋体" Height="22px" Width="40px" CssClass="textbox" Columns="2">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSetPageSize" runat="server" CssClass="labelBlack">每页</asp:linkbutton><asp:textbox id="txtPageSize" runat="server" Font-Size="12px" Font-Name="宋体" Height="22px" Width="40px" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
															<TD class="labelBlack" vAlign="middle" align="right" width="140"><asp:label id="lblGridLocInfo" runat="server" Font-Size="12px" CssClass="labelBlack">1/10 N/15</asp:label></TD>
														</TR>
													</TABLE>
												</TD>
											</TR>

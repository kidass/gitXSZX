<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="xtgl_sjdx_fwq.aspx.vb" Inherits="Xydc.Platform.web.xtgl_sjdx_fwq" %>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" style="HEIGHT: 22px" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtFWQMC" runat="server" Height="24px" Wrap="False" Font-Size="12px" Font-Names="宋体" Columns="36" CssClass="textbox"></asp:textbox><FONT color="#ff0000">*</FONT></SPAN></TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								</TR>
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtFWQLX" runat="server" Height="24px" Wrap="False" Font-Size="12px" Font-Names="宋体" Columns="36" CssClass="textbox"></asp:textbox>(系统给定)<FONT color="#ff0000">*</FONT></SPAN></TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								</TR>
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" style="HEIGHT: 32px" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtFWQTGZ" runat="server" Height="24px" Wrap="False" Font-Size="12px" Font-Names="宋体" Columns="36" CssClass="textbox"></asp:textbox>(系统给定)<FONT color="#ff0000">*</FONT></SPAN>&nbsp;&nbsp;
									</TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								...
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" style="HEIGHT: 32px" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtSJKMC" runat="server" Height="24px" Wrap="False" Font-Size="12px" Font-Names="宋体" Columns="36" CssClass="textbox"></asp:textbox>(系统给定)<FONT color="#ff0000">*</FONT></SPAN>&nbsp;&nbsp;
									</TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								...
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" style="HEIGHT: 22px" align="left" height="32"><SPAN class="labelNotNull"><asp:textbox id="txtUserId" runat="server" Height="24px" Wrap="False" Font-Size="12px" Font-Names="宋体" Columns="16" CssClass="textbox"></asp:textbox><FONT color="#ff0000">*</FONT></SPAN></TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								</TR>
								<TR vAlign="middle">
									...
									<TD class="labelNotNull" style="HEIGHT: 22px" align="left" height="32"><INPUT class="textbox" id="txtUserPwd" style="FONT-SIZE: 12px; FONT-FAMILY: 宋体"  type="password" size="36" runat="server"></TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								</TR>
								<TR vAlign="middle">
									...
									<TD class="label" align="left" height="32"><asp:textbox id="txtFWQSM" runat="server" Height="136px" Font-Size="12px" Font-Names="宋体" Columns="60" CssClass="textbox" TextMode="MultiLine"></asp:textbox></TD>
								</TR>
								<TR vAlign="middle" align="center" height="10">
									<TD class="label" colSpan="2"></TD>
								</TR>

...
Namespace Xydc.Platform.web
    ...
    Partial Public Class xtgl_rz_cz
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "xtgl_rz_cz_previlege_param"
        Private m_blnPrevilegeParams(1) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMXtglRzCz
        ...
        '要访问的数据
        '----------------------------------------------------------------
        Private m_objDataSet_LOG As Xydc.Platform.Common.Data.CustomerData
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMXtglRzCz
            ...
            Try
                ...
                If Not (objISjcxCxtj Is Nothing) Then
                    If objISjcxCxtj.oExitMode = True Then
                        ...
                        Me.htxtLOGQuery.Value = objISjcxCxtj.oQueryString
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMXtglRzCz)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_LOG( _
            ...
            Try
                ...
                strYHBS = "a." + Xydc.Platform.Common.Data.CustomerData.FIELD_GL_B_YONGHUCAOZUORIZHI_CZR
                ...
                strCZMS = "a." + Xydc.Platform.Common.Data.CustomerData.FIELD_GL_B_YONGHUCAOZUORIZHI_CZSM
                ...
                strCZSJ = "a." + Xydc.Platform.Common.Data.CustomerData.FIELD_GL_B_YONGHUCAOZUORIZHI_CZSJ
                ...
                If Me.txtLOGSearch_CZSJMin.Text <> "" And Me.txtLOGSearch_CZSJMax.Text <> "" Then
                    ...
                    End If
                    If strQuery = "" Then
                        strQuery = strCZSJ + " between '" + Me.txtLOGSearch_CZSJMin.Text + "' and '" + Me.txtLOGSearch_CZSJMax.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strCZSJ + " between '" + Me.txtLOGSearch_CZSJMin.Text + "' and '" + Me.txtLOGSearch_CZSJMax.Text + "'"
                    End If
...
errProc:
        ...
        Private Function getModuleData_LOG( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.CustomerData.TABLE_GL_B_YONGHUCAOZUORIZHI
            ...
            Try
                ...
                '重新检索数据
                If objsystemCustomer.getYonghuCaozuoRizhiData(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet_LOG) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditSJInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[一般用户操作审计日志]！")
                End If
            End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                '检查模版文件
                Dim strMBURL As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "管理_日志_一般用户操作审计日志一览表.xls"
                ...
                '输出数据
                If objsystemCustomer.doExportToExcel(strErrMsg, Me.m_objDataSet_LOG, strTempSpec) = False Then
                    GoTo errProc
                End If
            ...
            Try
                ...
                With objISjcxCxtj
                    ...
                    Else
                        .iDataSetTJ = Nothing
                    End If
                    .iQueryTable = Me.m_objDataSet_LOG.Tables(strTable)
                    .iFixQuery = ""

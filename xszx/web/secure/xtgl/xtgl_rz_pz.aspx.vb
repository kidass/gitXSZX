...
Namespace Xydc.Platform.web
    ...
    Partial Public Class xtgl_rz_pz
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "xtgl_rz_pz_previlege_param"
        Private m_blnPrevilegeParams(1) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMXtglRzPz
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMXtglRzPz
        ...
        Private Function getInterfaceParameters( _
            ...
            Try
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMXtglRzPz)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_LOG( _
            ...
            Try
                ...
                strYHBS = Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_VT_B_AUDITPZLOG_OPUSER
                ...
                strCZMS = Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_VT_B_AUDITPZLOG_OPNOTE
                ...
                strCZSJ = "convert(" + Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_VT_B_AUDITPZLOG_OPTIME + ", 'System.DateTime')"
...
errProc:
        ...
        Private Function getModuleData_LOG( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.AppManagerData.TABLE_GL_VT_B_AUDITPZLOG
            Dim objsystemAppManager As New Xydc.Platform.BusinessFacade.systemAppManager
            ...
            Try
                ...
                If objsystemAppManager.getDataSet_AUDITPZLOG(strErrMsg, MyBase.UserId, MyBase.UserPassword, strTempPath, strWhere, Me.m_objDataSet_LOG) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditSJInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[配置管理员审计日志]！")
                End If
            End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                '检查模版文件
                Dim strMBURL As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "管理_日志_配置管理员审计日志一览表.xls"

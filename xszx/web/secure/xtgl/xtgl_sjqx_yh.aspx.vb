...
Namespace Xydc.Platform.web
    ...
    Partial Public Class xtgl_sjqx_yh
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMXtglSjqxYh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Xydc.Platform.BusinessFacade.IXtglSjqxYh
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMXtglSjqxYh
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Xydc.Platform.BusinessFacade.IXtglSjqxYh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMXtglSjqxYh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getModuleData_Object( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemAppManager.getDBUserPermissionsData(strErrMsg, objConnectionProperty, strDBUserName, strWhere, Me.m_objDataSet_Object) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function showModuleData_MAIN(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Me.lnkMLGrant.Enabled = Me.m_blnPrevilegeParams(8)
                Me.lnkMLRevoke.Enabled = Me.m_blnPrevilegeParams(9)
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[用户的数据库对象授权数据]！")
                End If
            End If
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    ...
                    If blnSelected = True Then
                        ...
                        If objsystemAppManager.doGrantDBUser(strErrMsg, objConnectionProperty, strDBUserName, strObjectName, strObjectType, objOptions) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]给[" + strDBUserName + "]用户授予[" + strObjectName + "]的相关权限！")
                    End If
                Next
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    ...
                    If blnSelected = True Then
                        strObjectName = objDataGridProcess.getDataGridCellValue(Me.grdObject.Items(i), intColIndex(0))
                        strObjectType = objDataGridProcess.getDataGridCellValue(Me.grdObject.Items(i), intColIndex(1))
                        If objsystemAppManager.doRevokeDBUser(strErrMsg, objConnectionProperty, strDBUserName, strObjectName, strObjectType, objOptions) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]从[" + strDBUserName + "]用户回收[" + strObjectName + "]的相关权限！")
                    End If
                Next

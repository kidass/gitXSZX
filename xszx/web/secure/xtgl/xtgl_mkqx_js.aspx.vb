...
Namespace Xydc.Platform.web
    ...
    Partial Public Class xtgl_mkqx_js
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMXtglMkqxJs
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Xydc.Platform.BusinessFacade.IXtglMkqxJs
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMXtglMkqxJs
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Xydc.Platform.BusinessFacade.IXtglMkqxJs)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMXtglMkqxJs)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getModuleData_Object( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemAppManager.getRoleMokuaiQXData(strErrMsg, objConnectionProperty, strRoleName, strWhere, Me.m_objDataSet_Object) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function showModuleData_MAIN(ByRef strErrMsg As String) As Boolean
            ...
            Try
                Me.lnkMLUserQX.Enabled = Me.m_blnPrevilegeParams(1)
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[角色的应用模块权限设置数据]！")
                End If
            End If
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    ...
                    If blnSelected = True Then
                        ...
                        If objsystemAppManager.doGrantRoleMokuaiQX(strErrMsg, MyBase.UserId, MyBase.UserPassword, strRoleName, strMKBS) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]向[" + strRoleName + "]角色授予[" + strMKMC + "]应用模块的执行权限！")
                    End If
                Next
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    ...
                    If blnSelected = True Then
                        ...
                        If objsystemAppManager.doRevokeRoleMokuaiQX(strErrMsg, MyBase.UserId, MyBase.UserPassword, strRoleName, strMKBS) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]从[" + strRoleName + "]角色收回[" + strMKMC + "]应用模块的执行权限！")
                    End If
                Next

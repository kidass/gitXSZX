<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="xtgl_yhgl_js.aspx.vb" Inherits="Xydc.Platform.web.xtgl_yhgl_js" %>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRoleGL" runat="server" Font-Name="宋体" Font-Size="12px" Enabled="False"><img src="../../images/users.ico" alt="role" border="0" width="16" height="16">角色管理</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUserGL" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/user.ico" alt="user" border="0" width="16" height="16">用户管理</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAddRole" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/new.gif" alt="addnew" border="0" width="16" height="16">定义角色</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLDeleteRole" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/delete.gif" alt="delete" border="0" width="16" height="16">删除角色</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLMoveIn" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/movein.ico" alt="movein" border="0" width="16" height="16">加入用户</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLMoveOut" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/moveout.ico" alt="moveout" border="0" width="16" height="16">移出用户</asp:linkbutton></TD>
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtYRSearchRYDM" runat="server" Font-Size="12px" CssClass="textbox" Columns="12" height="22px" Font-Names="宋体"></asp:textbox></TD>
															...
															<TD class="label" align="left"><asp:textbox id="txtYRSearchZZMC" runat="server" Font-Size="12px" CssClass="textbox" Columns="18" height="22px" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;职务&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtYRSearchGWLB" runat="server" Font-Size="12px" CssClass="textbox" Columns="18" height="22px" Font-Names="宋体"></asp:textbox></TD>
												...
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															...
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZYRGotoPage" runat="server" CssClass="labelBlack">前往</asp:linkbutton><asp:textbox id="txtYRPageIndex" runat="server" Font-Name="宋体" Font-Size="12px" Width="40px" CssClass="textbox" Columns="2" height="22px">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZYRSetPageSize" runat="server" CssClass="labelBlack">每页</asp:linkbutton><asp:textbox id="txtYRPageSize" runat="server" Font-Name="宋体" Font-Size="12px" Width="40px" CssClass="textbox" Columns="3" height="22px">30</asp:textbox>条</TD>
											...
											<TR align="center">
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															<TD class="label" vAlign="middle" align="right">标识&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtWRSearchRYDM" runat="server" Font-Size="12px" CssClass="textbox" Columns="12" height="22px" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;名称&nbsp;</TD>
															...
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;单位&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtWRSearchZZMC" runat="server" Font-Size="12px" CssClass="textbox" Columns="18" height="22px" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;职务&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtWRSearchGWLB" runat="server" Font-Size="12px" CssClass="textbox" Columns="18" height="22px" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;级别&nbsp;</TD>
												...
												<TD class="label" style="">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															...
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZWRGotoPage" runat="server" CssClass="labelBlack">前往</asp:linkbutton><asp:textbox id="txtWRPageIndex" runat="server" Font-Name="宋体" Font-Size="12px" Width="40px" CssClass="textbox" Columns="2" height="22px">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZWRSetPageSize" runat="server" CssClass="labelBlack">每页</asp:linkbutton><asp:textbox id="txtWRPageSize" runat="server" Font-Name="宋体" Font-Size="12px" Width="40px" CssClass="textbox" Columns="3" height="22px">30</asp:textbox>条</TD>
					...
					<TR>
						...
						<TD align="center" style="BORDER-TOP: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRoleGLB" runat="server" Font-Name="宋体" Font-Size="12px" Enabled="False"><img src="../../images/users.ico" alt="role" border="0" width="16" height="16">角色管理</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLUserGLB" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/user.ico" alt="user" border="0" width="16" height="16">用户管理</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAddRoleB" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/new.gif" alt="addnew" border="0" width="16" height="16">定义角色</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLDeleteRoleB" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/delete.gif" alt="delete" border="0" width="16" height="16">删除角色</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLMoveInB" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/movein.ico" alt="movein" border="0" width="16" height="16">加入用户</asp:linkbutton></TD>
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLMoveOutB" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/moveout.ico" alt="moveout" border="0" width="16" height="16">移出用户</asp:linkbutton></TD>

...
Namespace Xydc.Platform.web
    ...
    Partial Public Class xtgl_yhgl_js
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMXtglYhglJs
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Xydc.Platform.BusinessFacade.IXtglYhglJs
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMXtglYhglJs
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Xydc.Platform.BusinessFacade.IXtglYhglJs)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMXtglYhglJs)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getModuleData_YR( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemAppManager.getRenyuanInRoleData(strErrMsg, objConnectionProperty, strRoleName, strWhere, Me.m_objDataSet_YR) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function getModuleData_WR( _
            ...
            Try
                ...
                '重新检索数据
                If objsystemAppManager.getRenyuanNotInRoleData(strErrMsg, objConnectionProperty, strRoleName, strWhere, Me.m_objDataSet_WR) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Function showModuleData_MAIN(ByRef strErrMsg As String) As Boolean
            ...
            Try
                Me.lnkMLUserGL.Enabled = Me.m_blnPrevilegeParams(1)
                Me.lnkMLUserGLB.Enabled = Me.m_blnPrevilegeParams(1)

                Me.lnkMLAddRole.Enabled = Me.m_blnPrevilegeParams(6)
                Me.lnkMLAddRoleB.Enabled = Me.m_blnPrevilegeParams(6)
                Me.lnkMLDeleteRole.Enabled = Me.m_blnPrevilegeParams(7)
                Me.lnkMLDeleteRoleB.Enabled = Me.m_blnPrevilegeParams(7)
                Me.lnkMLMoveIn.Enabled = Me.m_blnPrevilegeParams(8)
                Me.lnkMLMoveInB.Enabled = Me.m_blnPrevilegeParams(8)
                Me.lnkMLMoveOut.Enabled = Me.m_blnPrevilegeParams(9)
                Me.lnkMLMoveOutB.Enabled = Me.m_blnPrevilegeParams(9)
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[角色定义信息]！")
                End If
            End If
...
errProc:
        ...
        '模块特殊操作处理器
        '----------------------------------------------------------------
        Private Sub doAddRole(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doInputBox(Me.popMessageObject, "请输入角色名：", strControlId, intStep)
                    Exit Try
                Else
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '获取角色名
                    strRoleName = objMessageProcess.getInputBoxValue(Request, Me.popMessageObject.UniqueID)

                    '创建角色
                    With New Xydc.Platform.BusinessFacade.systemAppManager
                        If .doAddRole(strErrMsg, objConnectionProperty, strRoleName) = False Then
                            GoTo errProc
                        End If
                    End With

                    '记录审计日志
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]定义了[" + strRoleName + "]角色！")

                    '刷新显示
                    '获取数据库级的节点
                    Dim strNodeIndex As String
                    strNodeIndex = objTreeviewProcess.getLevelIndexFromNodeIndex(Me.tvwServers.SelectedNodeIndex, 3, True)
                    Dim objTreeNode As Microsoft.Web.UI.WebControls.TreeNode
                    objTreeNode = Me.tvwServers.GetNodeFromIndex(strNodeIndex)
                    If objTreeNode Is Nothing Then Exit Try
...
errProc:
        ...
        Private Sub doDropRole(ByVal strControlId As String)
            ...
            Try
                ...
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定要删除角色[" + strRoleName + "]吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '删除角色
                    With New Xydc.Platform.BusinessFacade.systemAppManager
                        If .doDropRole(strErrMsg, objConnectionProperty, strRoleName) = False Then
                            GoTo errProc
                        End If
                    End With

                    '记录审计日志
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]删除了[" + strRoleName + "]角色！")
                    ...
                    '重新定位
                    If objTreeNode.Nodes.Count > 0 Then
                        Me.tvwServers.SelectedNodeIndex = objTreeNode.Nodes(0).GetNodeIndex
                    Else
                        Me.tvwServers.SelectedNodeIndex = objTreeNode.GetNodeIndex
                    End If
                    '显示网格信息
                    If Me.getModuleData_YR(strErrMsg, Me.m_strQuery_YR) = False Then
                        GoTo errProc
        ...
        Private Sub doAddRoleMember(ByVal strControlId As String)
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    blnSelected = objDataGridProcess.isDataGridItemChecked(Me.grdWR.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_WR)
                    If blnSelected = True Then
                        strMemberName = objDataGridProcess.getDataGridCellValue(Me.grdWR.Items(i), intColIndex)
                        If objsystemAppManager.doAddRoleMember(strErrMsg, objConnectionProperty, strRoleName, strMemberName) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]向[" + strRoleName + "]角色增加了[" + strMemberName + "]成员！")
                    End If
                Next
...
errProc:
        ...
        Private Sub doDropRoleMember(ByVal strControlId As String)
            ...
            Try
                ...
                For i = 0 To intCount - 1 Step 1
                    blnSelected = objDataGridProcess.isDataGridItemChecked(Me.grdYR.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_YR)
                    If blnSelected = True Then
                        strMemberName = objDataGridProcess.getDataGridCellValue(Me.grdYR.Items(i), intColIndex)
                        If objsystemAppManager.doDropRoleMember(strErrMsg, objConnectionProperty, strRoleName, strMemberName) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]从[" + strRoleName + "]角色中删除了[" + strMemberName + "]成员！")
                    End If
                Next
...
errProc:
        ...
        Private Sub lnkMLUserGL_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLUserGL.Click

            Me.releaseModuleParameters()
            Me.releaseInterfaceParameters()

            Dim strUrl As String = "xtgl_yhgl_yh.aspx"
            Response.Redirect(strUrl)

        End Sub

        Private Sub lnkMLUserGLB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLUserGLB.Click
        ...
        Private Sub lnkMLAddRole_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLAddRole.Click
            Me.doAddRole("lnkMLAddRole")
        End Sub

        Private Sub lnkMLAddRoleB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLAddRoleB.Click
            Me.doAddRole("lnkMLAddRoleB")
        End Sub

        Private Sub lnkMLDeleteRole_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLDeleteRole.Click
            Me.doDropRole("lnkMLDeleteRole")
        End Sub

        Private Sub lnkMLDeleteRoleB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLDeleteRoleB.Click
            Me.doDropRole("lnkMLDeleteRoleB")
        End Sub

        Private Sub lnkMLMoveIn_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLMoveIn.Click
            Me.doAddRoleMember("lnkMLMoveIn")
        End Sub

        Private Sub lnkMLMoveInB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLMoveInB.Click
            Me.doAddRoleMember("lnkMLMoveInB")
        End Sub

        Private Sub lnkMLMoveOut_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLMoveOut.Click
            Me.doDropRoleMember("lnkMLMoveOut")
        End Sub

        Private Sub lnkMLMoveOutB_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLMoveOutB.Click
            Me.doDropRoleMember("lnkMLMoveOutB")
        End Sub

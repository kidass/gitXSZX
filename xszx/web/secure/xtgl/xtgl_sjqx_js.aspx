<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="xtgl_sjqx_js.aspx.vb" Inherits="Xydc.Platform.web.xtgl_sjqx_js" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>应用系统数据权限管理窗(基于角色管理)</title>
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="left" height="24">
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLRoleQX" runat="server" Font-Name="宋体" Font-Size="12px" Enabled="False"><img src="../../images/users.ico" alt="open" border="0" width="16" height="16">角色授权</asp:linkbutton></TD>
									...
									<TD vAlign="middle" align="center" width="100"><asp:linkbutton id="lnkMLAccsQX" runat="server" Font-Name="宋体" Font-Size="12px"><img src="../../images/access.ico" alt="open" border="0" width="16" height="16">存取授权</asp:linkbutton></TD>
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="tips" align="left" colSpan="5"></TD>
								</TR>
								<TR>
									<TD width="5"></TD>
									<TD vAlign="top" align="left" width="220" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR>
												<TD><IEWC:TREEVIEW id="tvwServers" runat="server" Font-Name="宋体" Font-Size="12px" AutoPostBack="True" Width="220px" Height="460px" CssClass="label"></IEWC:TREEVIEW></TD>
											</TR>
										</TABLE>
									</TD>
									<TD width="5"></TD>
												...
												<TD class="label" align="left">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<TR>
															...
															<TD class="label" align="left"><asp:textbox id="txtSearchDXM" runat="server" Font-Size="12px" CssClass="textbox" Columns="24" height="22px" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;中文名&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchDXZWM" runat="server" Font-Size="12px" CssClass="textbox" Columns="36" height="22px" Font-Names="宋体"></asp:textbox></TD>
															<TD class="label" vAlign="middle" align="right">&nbsp;&nbsp;类型&nbsp;</TD>
															<TD class="label" align="left"><asp:textbox id="txtSearchDXLX" runat="server" Font-Size="12px" CssClass="textbox" Columns="10" height="22px" Font-Names="宋体"></asp:textbox></TD>
											...
											<TR>
												<TD>
													<DIV id="divObject" style="TABLE-LAYOUT: fixed; OVERFLOW: auto; WIDTH: 570px; CLIP: rect(0px 570px 360px 0px); HEIGHT: 360px">
														<asp:datagrid id="grdObject" runat="server" Font-Size="12px" CssClass="label" Font-Names="宋体"
												...
												<TD class="label">
													<TABLE cellSpacing="0" cellPadding="0" border="0" width="100%">
														<TR>
															...
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZGotoPage" runat="server" CssClass="labelBlack">前往</asp:linkbutton><asp:textbox id="txtPageIndex" runat="server" Font-Name="宋体" Font-Size="12px" Width="40px" Height="22px" CssClass="textbox" Columns="2">1</asp:textbox>页</TD>
															<TD class="labelBlack" vAlign="middle" align="left"><asp:linkbutton id="lnkCZSetPageSize" runat="server" CssClass="labelBlack">每页</asp:linkbutton><asp:textbox id="txtPageSize" runat="server" Font-Name="宋体" Font-Size="12px" Width="40px" Height="22px" CssClass="textbox" Columns="3">30</asp:textbox>条</TD>
													...
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20">
																<asp:checkboxlist id="cblObjectQX" Runat="server" Font-Size="12px" Width="400px" CssClass="label"

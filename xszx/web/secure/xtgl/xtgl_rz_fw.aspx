<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="xtgl_rz_fw.aspx.vb" Inherits="Xydc.Platform.web.xtgl_rz_fw" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" onresize="return window_onresize()" background="../../images/oabk.gif">
		<form id="frmXTGL_RZ_FW" method="post" runat="server">
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR>
									<TD class="title" align="center" colSpan="3" height="30">访问审计日志<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<TR>
									<TD width="5"></TD>

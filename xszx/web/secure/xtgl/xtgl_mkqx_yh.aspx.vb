...
Namespace Xydc.Platform.web
    ...
    Partial Public Class xtgl_mkqx_yh
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "xtgl_mkqx_previlege_param"
        Private m_blnPrevilegeParams(6) As Boolean

        '----------------------------------------------------------------
        '模块现场保留参数，恢复完成后立即释放session资源
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMXtglMkqxYh
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Xydc.Platform.BusinessFacade.IXtglMkqxYh
...
errProc:
        ...
        Private Sub restoreModuleInformation(ByVal strSessionId As String)
            ...
            Try
                ...
                With Me.m_objSaveScence
                    ...
                    Me.txtSearchMKDM.Text = .txtSearchMKDM
                    Me.txtSearchMKMC.Text = .txtSearchMKMC
                    Me.txtSearchMKSM.Text = .txtSearchMKSM
                    ...
                    For i = 1 To intCount - 1 Step 1
                        ...
                        Select Case i
                            ...
                            Case 3 '展开用户
                                ...
                                If objTreeNode Is Nothing Then Exit For
                                If objTreeviewProcess.doShowTreeNodeChildren(strErrMsg, objTreeNode, _
                                    objAppManagerData.Tables(Xydc.Platform.Common.Data.AppManagerData.TABLE_GL_B_SHUJUKU_DBUSER), _
                                    Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_SHUJUKU_DBUSER_UID, _
                                    Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_SHUJUKU_DBUSER_NAME, _
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMXtglMkqxYh
                ...
                With Me.m_objSaveScence
                    ...
                    .txtSearchMKDM = Me.txtSearchMKDM.Text
                    .txtSearchMKMC = Me.txtSearchMKMC.Text
                    .txtSearchMKSM = Me.txtSearchMKSM.Text
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Xydc.Platform.BusinessFacade.IXtglMkqxYh)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMXtglMkqxYh)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
                    If Me.m_objSaveScence Is Nothing Then
...
errProc:
        ...
        Private Function getQueryString_Object( _
            ...
            Try
                ...
                strMKDM = "a." + Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_YINGYONGXITONG_MOKUAIQX_MKDM
                If Me.txtSearchMKDM.Text.Length > 0 Then Me.txtSearchMKDM.Text = Me.txtSearchMKDM.Text.Trim()
                If Me.txtSearchMKDM.Text <> "" Then
                    If strQuery = "" Then
                        strQuery = strMKDM + " like '" + Me.txtSearchMKDM.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strMKDM + " like '" + Me.txtSearchMKDM.Text + "%'"
                    End If
                End If

                '按模块名称搜索
                Dim strMKMC As String
                strMKMC = "a." + Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_YINGYONGXITONG_MOKUAIQX_MKMC
                If Me.txtSearchMKMC.Text.Length > 0 Then Me.txtSearchMKMC.Text = Me.txtSearchMKMC.Text.Trim()
                If Me.txtSearchMKMC.Text <> "" Then
                    Me.txtSearchMKMC.Text = objPulicParameters.getNewSearchString(Me.txtSearchMKMC.Text)
                    If strQuery = "" Then
                        strQuery = strMKMC + " like '" + Me.txtSearchMKMC.Text + "%'"
                    Else
                        strQuery = strQuery + " and " + strMKMC + " like '" + Me.txtSearchMKMC.Text + "%'"
                    End If
                End If

                '按模块说明搜索
                Dim strMKSM As String
                strMKSM = "a." + Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_YINGYONGXITONG_MOKUAIQX_MKSM
                If Me.txtSearchMKSM.Text.Length > 0 Then Me.txtSearchMKSM.Text = Me.txtSearchMKSM.Text.Trim()
                If Me.txtSearchMKSM.Text <> "" Then
                    Me.txtSearchMKSM.Text = objPulicParameters.getNewSearchString(Me.txtSearchMKSM.Text)
                    If strQuery = "" Then
                        strQuery = strMKSM + " = '" + Me.txtSearchMKSM.Text + "'"
                    Else
                        strQuery = strQuery + " and " + strMKSM + " = '" + Me.txtSearchMKSM.Text + "'"
                    End If
                End If
...
errProc:
        ...
        Private Function getServerConnectionProperty( _
            ...
            ByRef strDBUserName As String) As Boolean
            ...
            Try
                ...
                Select Case intLevel
                    ...
                    Case 4    '用户层
                        strDBUserName = objTreeNode.Text
...
errProc:
        ...
        Private Function getModuleData_Object( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.AppManagerData.TABLE_GL_B_YINGYONGXITONG_MOKUAIQX
            Dim objsystemAppManager As New Xydc.Platform.BusinessFacade.systemAppManager
            ...
            Try
                ...
                If Me.getServerConnectionProperty(strErrMsg, Me.tvwServers.SelectedNodeIndex, objConnectionProperty, strDBUserName) = False Then
                    GoTo errProc
                End If
                ...
                '重新检索数据
                If objsystemAppManager.getDBUserMokuaiQXData(strErrMsg, objConnectionProperty, strDBUserName, strWhere, Me.m_objDataSet_Object) = False Then
                    GoTo errProc
                End If
            ...
            Try
                ...
                Select Case intLevel
                    ...
                    Case 2    '准备获取数据库数据
                        Dim objConnectionProperty As Xydc.Platform.Common.Utilities.ConnectionProperty
                        Dim strDBUserName As String
                        If Me.getServerConnectionProperty(strErrMsg, strNodeIndex, objConnectionProperty, strDBUserName) = False Then
                            GoTo errProc
                        End If
                    ...
                    Case 3    '准备获取用户数据
                        ...
                        If Me.getServerConnectionProperty(strErrMsg, strNodeIndex, objConnectionProperty, strDBUserName) = False Then
                            GoTo errProc
                        End If
                        If objsystemAppManager.getDBUserData(strErrMsg, objConnectionProperty, "", objAppManagerData) = False Then
                            GoTo errProc
                        End If
            ...
            If Me.IsPostBack = False Then
                ...
                Try
                    With New Xydc.Platform.web.ControlProcess
                        ...
                        .doTranslateKey(Me.txtSearchMKDM)
                        .doTranslateKey(Me.txtSearchMKMC)
                        .doTranslateKey(Me.txtSearchMKSM)
                    End With
                Catch ex As Exception
                    strErrMsg = ex.Message
                    GoTo errProc
        ...
        Private Sub Page_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]访问了[用户的应用模块权限设置数据]！")
                End If
            End If
...
errProc:
        ...
        Private Sub doGrant(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strMKMC As String
                intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObject, Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_YINGYONGXITONG_MOKUAI_MKBS)
                ...
                For i = 0 To intCount - 1 Step 1
                    blnSelected = objDataGridProcess.isDataGridItemChecked(Me.grdObject.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_Object)
                    If blnSelected = True Then
                        strMKBS = objDataGridProcess.getDataGridCellValue(Me.grdObject.Items(i), intColIndex(0))
                        strMKMC = objDataGridProcess.getDataGridCellValue(Me.grdObject.Items(i), intColIndex(1))

                        If objsystemAppManager.doGrantDBuserMokuaiQX(strErrMsg, MyBase.UserId, MyBase.UserPassword, strDBUserName, strMKBS) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]向[" + strDBUserName + "]用户授予[" + strMKMC + "]应用模块的执行权限！")
                    End If
                Next
                ...
                '提示成功
                objMessageProcess.doAlertMessage(Me.popMessageObject, "提示：选定[" + intSelected.ToString() + "]个模块已经成功授予权限！")
...
errProc:
        ...
        Private Sub doRevoke(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strMKMC As String
                Dim strMKBS As String
                intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObject, Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_YINGYONGXITONG_MOKUAIQX_MKBS)
                intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObject, Xydc.Platform.Common.Data.AppManagerData.FIELD_GL_B_YINGYONGXITONG_MOKUAIQX_MKMC)
                intCount = Me.grdObject.Items.Count
                For i = 0 To intCount - 1 Step 1
                    blnSelected = objDataGridProcess.isDataGridItemChecked(Me.grdObject.Items(i), 0, Me.m_cstrCheckBoxIdInDataGrid_Object)
                    If blnSelected = True Then
                        ...
                        If objsystemAppManager.doRevokeDBUserMokuaiQX(strErrMsg, MyBase.UserId, MyBase.UserPassword, strDBUserName, strMKBS) = False Then
                            GoTo errProc
                        End If

                        '记录审计日志
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditAQInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]从[" + strDBUserName + "]用户收回[" + strMKMC + "]应用模块的执行权限！")
                    End If
                Next
                ...
                '提示成功
                objMessageProcess.doAlertMessage(Me.popMessageObject, "提示：选定[" + intSelected.ToString() + "]个模块已经成功回收权限！")
...
errProc:
        ...
        Private Sub lnkMLRoleQX_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles lnkMLRoleQX.Click
            ...
            Me.releaseModuleParameters()
            Me.releaseInterfaceParameters()
            Dim strUrl As String = "xtgl_mkqx_js.aspx"
            Response.Redirect(strUrl)

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_MonthMatchHouse_x2.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_MonthMatchHouse_x2" %>
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD>
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 290px; CLIP: rect(0px 290px 300px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 300px">
														<asp:datagrid id="grdObjects" runat="server" runat="server" Width="270px" CssClass="labelGrid" 
											...
											<TR>
												<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20"><B>月楼盘匹配</B></TD>
														</TR>
														<TR>

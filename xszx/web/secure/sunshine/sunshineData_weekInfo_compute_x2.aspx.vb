...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_weekInfo_compute_x2
        ...
        Private Function getQueryString_Compute( _
            ...
            Try
                ...
                Else
                    ...
                    strSearchFied = "a.C_HOUSE"
                    If strQuery = "" Then
                        strQuery = strSearchFied + " in (select BuildingName from Sunshine_B_WeekMonitoringHouse) "
                    Else
                        strQuery = strQuery + " and " + strSearchFied + " in (select BuildingName from Sunshine_B_WeekMonitoringHouse) "
                    End If
                End If
...
errProc:
        ...
        Private Function getModuleData_Compute( _
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_WEEKBuildingCompute(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_WEEKBuildingCompute(strErrMsg, MyBase.UserId, MyBase.UserPassword, m_strQuery_Compute, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If

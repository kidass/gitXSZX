<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_houseInfo_compute_x2.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_houseInfo_compute_x2" %>
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
									<TD class="title" align="center" colSpan="3" height="30">【<%=propRYMC%>】能查看的数据统计<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>
												...
												<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<tr>	       
								           			    ...
								           			    <tr>
								           			        <td class="label"  align="right"  >&nbsp;是否使用月楼盘匹配&nbsp;</td>
												...
												<TD>
													<DIV id="divCompute" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 382px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 382px">
														<asp:datagrid id="grdCompute" runat="server" CssClass="labelGrid" Width="980px"
															...
															<Columns>																
																<asp:ButtonColumn Visible="false" ItemStyle-Width="0px" DataTextField="统计日期" SortExpression="统计日期" HeaderText="统计日期" CommandName="Select">
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="退房数" SortExpression="退房数" HeaderText="退房数" CommandName="Select">																	<HeaderStyle Width="80px"></HeaderStyle>
																<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>	

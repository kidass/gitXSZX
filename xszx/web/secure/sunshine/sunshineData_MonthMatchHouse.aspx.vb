...
Namespace Xydc.Platform.web
    ...
    '----------------------------------------------------------------
    ' 命名空间：Xydc.Platform
    ' 类名    ：sunshineData_MonthMatchHouse
    ' 
    ' 调用性质：
    '   独立运行
    '
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_MonthMonitoringHouse
            ...
            Try
                ...
                With New Xydc.Platform.BusinessFacade.systemSunshine
                    If .getMonthMonitoringHouse(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objSunshineDataSet) = False Then
                        GoTo errProc
                    End If
                End With
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                '保存信息
                With New Xydc.Platform.BusinessFacade.systemSunshine
                    If .doSaveSunshineMonthMonitoringHouse(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    '删除处理
                    If objsystemSunshine.doDeleteSunshineMonthMonitoringHouse(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                        GoTo errProc
                    End If

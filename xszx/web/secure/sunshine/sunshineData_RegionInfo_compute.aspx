<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_RegionInfo_compute_x2.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_RegionInfo_compute_x2" %>
					...
					<TR>
						...
						<TD vAlign="top" align="center">
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
									<TD class="title" align="center" colSpan="3" height="30">【<%=propRYMC%>】能查看的区域数据统计<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
								</TR>
								<tr>
								    <td height="4"></td>
								</tr>

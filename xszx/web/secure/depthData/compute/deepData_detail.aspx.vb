...
Namespace Xydc.Platform.web
    ...
    '   　“明细数据查询”处理模块
    '----------------------------------------------------------------
    Partial Public Class deepData_detail
...
errProc:
        ...
        Private Function getQueryString_Compute( _
            ...
            Try
                ...
                strStart = ""
                strEnd = ""
                strSearchFied = "a." + Xydc.Platform.Common.Data.DeepData.FIELD_House_B_SalesMessage_UnitPrice
                ...
                strStart = ""
                strEnd = ""
                strSearchFied = "a." + Xydc.Platform.Common.Data.DeepData.FIELD_House_B_SalesMessage_TotalPrice
...
errProc:
        ...
        '     False          ：失败
        '----------------------------------------------------------------
        Private Function getModuleData_Compute_Print( _
            ByRef strErrMsg As String, _
            ByVal strWhere As String, _
            ByVal blnControl As Boolean) As Boolean

            Dim strTable As String = Xydc.Platform.Common.Data.DeepData.TABLE_House_B_SalesMessage
            Dim objsystemDeepdata As New Xydc.Platform.BusinessFacade.systemDeepdata

            getModuleData_Compute_Print = False
            ...
            Try
                ...
                'If objsystemDeepdata.getDataSet_Detail(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet_Compute) = False Then
                '    GoTo errProc
                'End If
                If objsystemDeepdata.getDataSet_Detail_Print(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
            ...
            getModuleData_Compute_Print = True
            Exit Function
errProc:
            Xydc.Platform.BusinessFacade.systemDeepdata.SafeRelease(objsystemDeepdata)
            Exit Function
            ...
            Try
                ...
                With New Xydc.Platform.DataAccess.dacSystemOperate
                    If .doSaveOperateLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, _
                        Xydc.Platform.Common.Data.LogData.OperateType_select, Xydc.Platform.Common.Data.DeepData.TABLE_House_B_SalesMessage, strQuery) = False Then
                        GoTo errProc
                    End If
                End With
            Catch ex As Exception
...
errProc:
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    With New Xydc.Platform.DataAccess.dacSystemOperate
                        If .doSaveVisitLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "deepData_detail.aspx", "销售数据明细数据查询") = False Then
                            GoTo errProc
                        End If
                    End With
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                '    GoTo errProc
                'End If
                If Me.getModuleData_Compute_Print(strErrMsg, Me.m_strQuery_Compute, True) = False Then
                    GoTo errProc
                End If

                'If objsystemDeepdata.getDataSet_DetailCompute(strErrMsg, MyBase.UserId, MyBase.UserPassword, m_strQuery_Compute, intTop, strOrderBy, Me.m_objDataSet_Compute) = False Then
                '    GoTo errProc
                'End If
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "明细表.xls"

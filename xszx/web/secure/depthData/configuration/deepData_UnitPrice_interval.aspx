<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="deepData_UnitPrice_interval.aspx.vb" Inherits="Xydc.Platform.web.deepData_UnitPrice_interval" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>单价段代码编辑窗</title>
													...
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 100%; CLIP: rect(0px 100% 300px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 300px">
														<asp:datagrid id="grdObjects" runat="server" runat="server" Width="100%" CssClass="labelGrid" 
                                                            ...
                                                            <Columns>
																...
																<asp:ButtonColumn DataTextField="UnitPriceCode" SortExpression="UnitPriceCode" HeaderText="代码" CommandName="Select">
											...
											<TR>
												<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20"><B>单价统计段编辑窗</B></TD>
														</TR>
														<TR>

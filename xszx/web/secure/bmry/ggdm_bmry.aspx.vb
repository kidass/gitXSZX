...
Namespace Xydc.Platform.web
    ...
    Partial Public Class ggdm_bmry
        ...
        '----------------------------------------------------------------
        Private m_objSaveScence As Xydc.Platform.BusinessFacade.IMGgdmBmry
        Private m_blnSaveScence As Boolean

        '----------------------------------------------------------------
        '模块接口参数
        '----------------------------------------------------------------
        Private m_objInterface As Xydc.Platform.BusinessFacade.IGgdmBmry
...
errProc:
        ...
        Private Function saveModuleInformation() As String
            ...
            Try
                ...
                '创建对象
                Me.m_objSaveScence = New Xydc.Platform.BusinessFacade.IMGgdmBmry
        ...
        Private Function getDataFromCallModule( _
            ...
            Try
                ...
                '=================================================================
                Dim objIGgdmBmryBmxx As Xydc.Platform.BusinessFacade.IGgdmBmryBmxx
                Try
                    objIGgdmBmryBmxx = CType(Session.Item(Request.QueryString(Xydc.Platform.Common.Utilities.PulicParameters.OSessionId)), Xydc.Platform.BusinessFacade.IGgdmBmryBmxx)
                Catch ex As Exception
                ...
                '=================================================================
                Dim objIGgdmBmryRyxx As Xydc.Platform.BusinessFacade.IGgdmBmryRyxx
                Try
                    objIGgdmBmryRyxx = CType(Session.Item(Request.QueryString(Xydc.Platform.Common.Utilities.PulicParameters.OSessionId)), Xydc.Platform.BusinessFacade.IGgdmBmryRyxx)
                Catch ex As Exception
        ...
        Private Function getInterfaceParameters(ByRef strErrMsg As String) As Boolean
            ...
            Try
                ...
                Try
                    ...
                    m_objInterface = CType(objTemp, Xydc.Platform.BusinessFacade.IGgdmBmry)
                Catch ex As Exception
                ...
                If Me.IsPostBack = False Then
                    ...
                    Try
                        Me.m_objSaveScence = CType(Session.Item(strSessionId), Xydc.Platform.BusinessFacade.IMGgdmBmry)
                    Catch ex As Exception
                        Me.m_objSaveScence = Nothing
                    End Try
...
errProc:
        ...
        Private Sub doOpenBumen(ByVal strControlId As String)
            ...
            Try
                ...
                Dim objIGgdmBmryBmxx As Xydc.Platform.BusinessFacade.IGgdmBmryBmxx
                Dim strUrl As String
                objIGgdmBmryBmxx = New Xydc.Platform.BusinessFacade.IGgdmBmryBmxx
        ...
        Private Sub doAddNewBumenTJ(ByVal strControlId As String)
            ...
            Try
                ...
                Else
                    ...
                    With New Xydc.Platform.Common.Utilities.PulicParameters
                        strPrevZZDM = .getPrevLevelCode(Xydc.Platform.Common.Data.CustomerData.intZZDM_FJCDSM, strZZDM)
                    End With
                End If
            ...
            Try
                ...
                Else
                    ...
                    With New Xydc.Platform.Common.Utilities.PulicParameters
                        ...
                        intLevel = .getCodeLevel(Xydc.Platform.Common.Data.CustomerData.intZZDM_FJCDSM, strPrevZZDM.Length)
                        If intLevel >= Xydc.Platform.Common.Data.CustomerData.intZZDM_FJCDSM.Length Then
                            strErrMsg = "错误：单位级别只允许[" + Xydc.Platform.Common.Data.CustomerData.intZZDM_FJCDSM.Length.ToString() + "]级！"
                            GoTo errProc
                        End If
                    End With
                End If
...
errProc:
        ...
        Private Sub doDeleteBumen(ByVal strControlId As String)
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.CustomerData.TABLE_GG_B_ZUZHIJIGOU
            Dim objMessageProcess As New Xydc.Platform.web.MessageProcess
            Dim strErrMsg As String
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    With Me.m_objDataSet_BMXX.Tables(strTable)
                        .DefaultView.RowFilter = Xydc.Platform.Common.Data.CustomerData.FIELD_GG_B_ZUZHIJIGOU_ZZDM + "=" + strZZDM
                    ...
                    '记录审计日志
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]删除了[" + strZZMC + "]单位！")
                End If
...
errProc:
        ...
        Private Sub doOpenRenyuan(ByVal strControlId As String)
            ...
            Try
                ...
                With New Xydc.Platform.web.DataGridProcess
                    intColIndex = .getDataGridColumnIndex(Me.grdBMRY, Xydc.Platform.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM)
                ...
                Dim objIGgdmBmryRyxx As Xydc.Platform.BusinessFacade.IGgdmBmryRyxx
                Dim strUrl As String
                objIGgdmBmryRyxx = New Xydc.Platform.BusinessFacade.IGgdmBmryRyxx
        ...
        Private Sub doUpdateRenyuan(ByVal strControlId As String)
            ...
            Try
                ...
                With New Xydc.Platform.web.DataGridProcess
                    'intColIndex = .getDataGridColumnIndex(Me.grdBMRY, Xydc.Platform.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM)
                    'strRYDM = .getDataGridCellValue(Me.grdBMRY.Items(intRow), intColIndex)
                    intColIndex(0) = .getDataGridColumnIndex(Me.grdBMRY, Xydc.Platform.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYDM)
                    strRYDM = .getDataGridCellValue(Me.grdBMRY.Items(intRow), intColIndex(0))
                    intColIndex(1) = .getDataGridColumnIndex(Me.grdBMRY, Xydc.Platform.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_ZZDM)
                    strZZDM = .getDataGridCellValue(Me.grdBMRY.Items(intRow), intColIndex(1))
                    intColIndex(2) = .getDataGridColumnIndex(Me.grdBMRY, Xydc.Platform.Common.Data.CustomerData.FIELD_GG_B_RENYUAN_RYMC)
                ...
                strUrl += "ggdm_bmry_infoedit.aspx"
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    For i = intCount - 1 To 0 Step -1
                        ...
                        If blnSelected = True Then
                            ...
                            '记录审计日志
                            Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]删除了[" + strRYDM + "]账户！")
                        End If
                    Next
...
errProc:
        ...
        Private Sub doMoveDownRenyuan(ByVal strControlId As String)
            ...
            Try
                ...
                '记录审计日志
                Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]将[" + strRYDM + "]账户排序下移！")
...
errProc:
        ...
        Private Sub doMoveUpRenyuan(ByVal strControlId As String)
            ...
            Try
                ...
                '记录审计日志
                Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]将[" + strRYDM + "]账户排序上移！")

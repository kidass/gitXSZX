...
Namespace Xydc.Platform.web
    ...
    Partial Public Class customer_detail_medium
        ...
        '模块授权参数
        '----------------------------------------------------------------
        Private m_cstrPrevilegeParamPrefix As String = "customer_medium_previlege_param"
        ...
        '当前处理的数据集
        '----------------------------------------------------------------
        Private m_objDataSet_Compute As Xydc.Platform.Common.Data.CustomerMediumData
...
errProc:
        ...
        Private Function getQueryString_Compute( _
            ...
            Try
                ...
                strTxtTemp = ""
                strSearchFied = ""
                strSearchFied = Xydc.Platform.Common.Data.CustomerMediumData.FIELD_House_B_MediumCustomer_CompanyName
                strTxtTemp = Me.txtCompanyName.Text.Trim
                If strTxtTemp <> "" Then
                ...
                strTxtTemp = ""
                strSearchFied = ""
                strSearchFied = Xydc.Platform.Common.Data.CustomerMediumData.FIELD_House_B_MediumCustomer_Position
                strTxtTemp = Me.txtPosition.Text.Trim
                If strTxtTemp <> "" Then
                    strTxtTemp = objPulicParameters.getNewSearchString(strTxtTemp)
                    If strQuery = "" Then
                        strQuery = strSearchFied + " like '%" + strTxtTemp + "%'"
                ...
                strSearchFied = ""
                strTxtTemp = ""
                strSearchFied = Xydc.Platform.Common.Data.CustomerMediumData.FIELD_House_B_MediumCustomer_Adress
                strTxtTemp = Me.txtAddress.Text.Trim
                ...
                strSearchFied = ""
                strTxtTemp = ""
                strSearchFied = Xydc.Platform.Common.Data.CustomerMediumData.FIELD_House_B_MediumCustomer_CustomerType
                strTxtTemp = Me.txtCustomerType.Text.Trim
                If strTxtTemp <> "" Then
                    Dim strType() As String
                    Dim intCount_Type As Integer
                    Dim strAllType As String
                    Dim i As Integer

                    strType = strTxtTemp.Split(Xydc.Platform.Common.Utilities.PulicParameters.CharSeparate.ToCharArray())
                    intCount_Type = strType.Length
                    For i = 0 To intCount_Type - 1
                        If i = 0 Then
                            strAllType = "'" + strType(i) + "'"
                        Else
                            strAllType = strAllType + ",'" + strType(i) + "'"
                        End If
                    Next

                    If strQuery = "" Then
                        strQuery = strSearchFied + " in (" + strAllType + ")"
                    Else
                        strQuery = strQuery + " and " + strSearchFied + " in (" + strAllType + ")"
                    End If
                End If
...
errProc:
        ...
        Private Function getModuleData_Compute( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.CustomerMediumData.TABLE_House_B_MediumCustomer
            Dim objdacCustomer_operation As New Xydc.Platform.DataAccess.dacCustomer_operation
            ...
            Try
                ...
                '释放资源
                Xydc.Platform.Common.Data.CustomerMediumData.SafeRelease(Me.m_objDataSet_Compute)

                '重新检索数据


                If objdacCustomer_operation.getDataSet_MediumCustomerDetail(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
            ...
            Xydc.Platform.DataAccess.dacCustomer_operation.SafeRelease(objdacCustomer_operation)
            ...
            Try
                ...
                With New Xydc.Platform.DataAccess.dacSystemOperate
                    If .doSaveOperateLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, _
                        Xydc.Platform.Common.Data.LogData.OperateType_select, Xydc.Platform.Common.Data.CustomerMediumData.TABLE_House_B_MediumCustomer, strQuery) = False Then
                        GoTo errProc
                    End If
                End With
...
errProc:
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    With New Xydc.Platform.DataAccess.dacSystemOperate
                        If .doSaveVisitLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "customer_detail_medium.aspx", "二手客户明细数据查询") = False Then
                            GoTo errProc
                        End If
                    End With
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "二手客户明细表.xls"
                ...
                If objdacCustomer_operation.doExportToExcel(strErrMsg, m_objDataSet_Compute, strDesExcelSpec) = False Then
                    GoTo errProc
                End If

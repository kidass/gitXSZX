...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_weekInfo_compute
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "周阳光家缘房产信息表.xls"

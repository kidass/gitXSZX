<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_houseInfo_compute.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_houseInfo_compute" %>
										...
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<TR id="trRow02">
												<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														<tr>
											                <td class="label"  align="right">&nbsp;截数日期&nbsp;</TD>

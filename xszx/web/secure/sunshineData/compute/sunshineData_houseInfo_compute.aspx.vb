...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_houseInfo_compute
...
errProc:
        ...
        Private Function getModuleData_Compute( _
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_BuildingCompute(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_BuildingCompute(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.htxtComputeQuery.Value, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "阳光家缘房产信息表.xls"

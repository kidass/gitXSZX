...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_RegionInfo_compute_v2
...
errProc:
        ...
        Private Function getModuleData_Compute( _
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_RegionBuildingCompute_v2(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_RegionBuildingCompute_v2(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.m_strQuery_Compute, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If

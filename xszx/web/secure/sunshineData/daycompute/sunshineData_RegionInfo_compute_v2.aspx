<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_RegionInfo_compute_v2.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_RegionInfo_compute_v2" %>
<%@ Register Assembly="DateTimePickerControls" Namespace="DateTimePickerControls"  TagPrefix="DTP" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>阳光家缘房地产项目区域统计界面</title>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
								    <td  colspan="2">
								        <table  width="100%">
								            <tr>
									            <TD class="title" align="center" style="width:95%"  height="30">【<%=propRYMC%>】能查看的周区域数据统计<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
													...
													<DIV id="divCompute" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 382px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 382px">
														<asp:datagrid id="grdCompute" runat="server" CssClass="labelGrid" Width="980px"
															...
															<Columns>	
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签数" SortExpression="网签数" HeaderText="本周成交套数" CommandName="Select">																	<HeaderStyle Width="80px"></HeaderStyle>
																<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>	
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="上周网签数" SortExpression="上周网签数" HeaderText="上周成交套数" CommandName="OpenDocument">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>	
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签数环比" SortExpression="网签数环比" HeaderText="成交套数环比" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="网签均价" SortExpression="网签均价" HeaderText="本周成交均价" CommandName="Select">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>																															
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="上周网签均价" SortExpression="上周网签均价" HeaderText="上周成交均价" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>		
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签均价环比" SortExpression="网签均价环比" HeaderText="价格涨幅" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>	
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签总额" SortExpression="网签总额" HeaderText="成交总额" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>		
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签面积" SortExpression="网签面积" HeaderText="成交面积" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>																										
															</Columns>

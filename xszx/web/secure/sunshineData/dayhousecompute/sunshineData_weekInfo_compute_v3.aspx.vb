...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_weekInfo_compute_v3
...
errProc:
        ...
        Private Function getQueryString_Compute( _
            ...
            Try
                ...
                If rblTop.SelectedValue = "1" Then
                    '按楼盘名称
                    strSearchFied = ""
                    strTxtTemp = ""
...
errProc:
        ...
        Private Function getModuleData_Compute( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_V_WeekInfo_Statistics
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_WEEKBuildingCompute_v3(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
            ...
            Try
                ...
                With New Xydc.Platform.DataAccess.dacSystemOperate
                    If .doSaveOperateLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, _
                        Xydc.Platform.Common.Data.LogData.OperateType_select, Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_V_WeekInfo_Statistics, strQuery) = False Then
                        GoTo errProc
                    End If
                End With
            Catch ex As Exception
...
errProc:
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    With New Xydc.Platform.DataAccess.dacSystemOperate
                        If .doSaveVisitLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "sunshineData_weekInfo_compute_v3.aspx", "项目信息周数据查询") = False Then
                            GoTo errProc
                        End If
                    End With
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_WEEKBuildingCompute_v3(strErrMsg, MyBase.UserId, MyBase.UserPassword, m_strQuery_Compute, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "周阳光家缘房产信息统计表.xls"

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_houseDetail_compute.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_houseDetail_compute" %>
<%@ Register Assembly="DateTimePickerControls" Namespace="DateTimePickerControls"  TagPrefix="DTP" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>阳光家缘房地产项目楼盘明细查询界面</title>
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								<TR id="trRow01">
								     <td  colspan="2">
								        <table  width="100%">
								            <tr>
									            <TD class="title" align="center" style="width:95%" height="30">【<%=propRYMC%>】能查看的数据统计<asp:LinkButton id="lnkBlank" Runat="server" Width="0px"></asp:LinkButton></TD>
														...
														<tr>	
														    <td class="label"  align="right">&nbsp;区域&nbsp;</td>
									               	        <td align="left"><asp:DropDownList id="ddlRegion" Runat="server" CssClass="textbox" Columns="12"  Width="85px">
					                                            ...
					                                            <asp:DropDownList id="ddlBuildingMatch" Visible=false  Runat="server" CssClass="textbox" Columns="12">
                                                                <asp:ListItem Value="0" Selected="True">选择匹配</asp:ListItem>
					                                            <asp:ListItem Value="1">月楼盘匹配</asp:ListItem>
					                                            <asp:ListItem Value="2">周楼盘匹配</asp:ListItem>
					                                            </asp:DropDownList>
                                                            </td>	       
														</tr>	
								           			    <tr>
								                            ...
								                            <asp:textbox id="txtBuildingName" runat="server" CssClass="textbox" Columns="20"></asp:textbox>
                                                             &nbsp;预售证&nbsp;
								                            <asp:textbox id="txtPresellId" runat="server" CssClass="textbox" Columns="20"></asp:textbox> </TD> 
								           			     </tr>
														 <tr>
														    <td>&nbsp;</td>
														    <td colspan="4" align="left"><asp:button  Width="200px"  id="btnSearch" Runat="server" CssClass="button" Text=" 查 询 "></asp:button></td>	
														 </tr>	
													</TABLE>
												</TD>
											...
											<TR>
												<TD>
													<DIV id="divCompute" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 964px; CLIP: rect(0px 964px 382px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 382px">
														<asp:datagrid id="grdCompute" runat="server" CssClass="labelGrid" Width="1160px"
															...
															<Columns>																
																<asp:ButtonColumn Visible="false" ItemStyle-Width="0px" DataTextField="开始日期" SortExpression="开始日期" HeaderText="开始日期" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn Visible="false" ItemStyle-Width="0px" DataTextField="结束日期" SortExpression="结束日期" HeaderText="结束日期" CommandName="OpenDocument">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																...
																<asp:ButtonColumn ItemStyle-Width="200px" DataTextField="项目名称" SortExpression="项目名称" HeaderText="项目名称" CommandName="OpenDocument">
																...
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="预售证" SortExpression="预售证" HeaderText="预售证" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>																										
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签数" SortExpression="网签数" HeaderText="网签数" CommandName="Select">																	<HeaderStyle Width="80px"></HeaderStyle>
																<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>	
																<asp:ButtonColumn ItemStyle-Width="120px" DataTextField="网签均价" SortExpression="网签均价" HeaderText="网签均价" CommandName="Select">
																	<HeaderStyle Width="120px"></HeaderStyle>
																</asp:ButtonColumn>		
																<asp:ButtonColumn ItemStyle-Width="100px" DataTextField="网签面积" SortExpression="网签面积" HeaderText="网签面积" CommandName="OpenDocument">
																	<HeaderStyle Width="100px"></HeaderStyle>
																</asp:ButtonColumn>														
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="网签总额" SortExpression="网签总额" HeaderText="网签总额" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>																		
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="合共成交" SortExpression="合共成交" HeaderText="合共成交套数" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="退房数" SortExpression="退房数" HeaderText="退房数" CommandName="OpenDocument">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="未售套数" SortExpression="未售套数" HeaderText="未售套数" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>	
																<asp:ButtonColumn ItemStyle-Width="80px" DataTextField="合共均价" SortExpression="合共均价" HeaderText="合共均价" CommandName="Select">
																	<HeaderStyle Width="80px"></HeaderStyle>
																</asp:ButtonColumn>																									
															</Columns>

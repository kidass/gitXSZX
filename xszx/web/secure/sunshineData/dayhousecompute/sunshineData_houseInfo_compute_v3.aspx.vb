...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_houseInfo_compute_v3
...
errProc:
        ...
        Private Function getModuleData_Compute( _
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_BuildingCompute_v3(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
...
errProc:
        ...
        Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    With New Xydc.Platform.DataAccess.dacSystemOperate
                        If .doSaveVisitLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "sunshineData_houseInfo_compute_v3.aspx", "项目信息综合查询") = False Then
                            GoTo errProc
                        End If
                    End With
                End If
...
errProc:
        ...
        Private Sub doPrint(ByVal strControlId As String)
            ...
            Try
                ...
                If objsystemSunshine.getDataSet_BuildingCompute_v3(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.htxtComputeQuery.Value, objParameter, Me.m_objDataSet_Compute) = False Then
                    GoTo errProc
                End If
                ...
                Dim strSrcExcelSpec As String = Request.ApplicationPath + Me.m_cstrExcelMBRelativePathToAppRoot + "阳光家缘房产信息统计表.xls"

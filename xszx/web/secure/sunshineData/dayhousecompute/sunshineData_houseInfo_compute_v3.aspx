<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_houseInfo_compute_v3.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_houseInfo_compute_v3" %>
<%@ Register Assembly="DateTimePickerControls" Namespace="DateTimePickerControls"  TagPrefix="DTP" %>
<%@ Register TagPrefix="uwin" Namespace="Josco.Web" Assembly="Josco.Web.PopMessage" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<HTML>
	<HEAD>
		<title>阳光家缘房地产项目信息查询界面</title>
														...
														<tr>	
														    <td class="label"  align="right">&nbsp;区域&nbsp;</td>
									               	        <td align="left"><asp:DropDownList id="ddlRegion" Runat="server" CssClass="textbox" Columns="12"  Width="85px">
					                                            ...
					                                            <asp:DropDownList id="ddlBuildingMatch" Runat="server" CssClass="textbox" Columns="12">

...
Namespace Xydc.Platform.web
    ...
    '   　“楼盘排序”处理模块
    '----------------------------------------------------------------
    Partial Public Class sunhineData_House_Sort
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_HOUSEMATCHSORT
            ...
            Try
                ...
                '重新检索数据
                With New Xydc.Platform.BusinessFacade.systemSunshine
                    If .getHouseSort(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objSunshineDataSet) = False Then
                        GoTo errProc
                    End If
                End With
...
errProc:
        ...
        Private Function getModuleData_HOUSEMATCH( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_HOUSE_MATCH
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_NAME)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_Sort)
                        intColIndex(2) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_V_HOUSEMATCHSORT_Type)
                        Me.txtBuildingName.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtProjectName.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))

                        strDDL = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(2))
                        Select Case strDDL
                            Case "商业"
                                strDDL = "1"
                            Case "住宅"
            ...
            Try
                ...
                Select Case Me.m_objenumEditType
                    ...
                    Case Else
                        ...
                        strWhere = " I_ID=convert(integer," + CStr(intID) + ") "
                End Select

                '检查序号是否存在
                Dim blnExist As Boolean = False
                With New Xydc.Platform.DataAccess.dacSunshine
                    If .checkSort(strErrMsg, MyBase.UserId, MyBase.UserPassword, Me.txtProjectName.Text, Me.rblHouseType.SelectedValue, blnExist) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                strValue = Me.rblHouseType.SelectedValue
                ...
                If blnExist = True Then
                    ...
                    If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                        ...
                        objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：" + strType + "的[" + Me.txtProjectName.Text + "]已存在，是否插入吗（是/否）？", strControlId, intStep)
                        Exit Try
                    Else
                    ...
                    If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                        ...
                        objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_NAME, Me.txtBuildingName.Text)
                        objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_Sort, Me.txtProjectName.Text)
                        objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_Type, Me.rblHouseType.SelectedValue)

                        '保存信息
                        With New Xydc.Platform.DataAccess.dacSunshine
                            If .doSaveExistSort(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                                GoTo errProc
                            End If
                        End With
                        ...
                        Select Case Me.m_objenumEditType
                            Case Xydc.Platform.Common.Utilities.PulicParameters.enumEditType.eAddNew
                                Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[楼盘排序]字典中增加了[" + Me.txtBuildingName.Text + "]！")
                            Case Else
                ...
                Else
                    ...
                    objNewData.Add("s" + Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_NAME, Me.txtBuildingName.Text)
                    objNewData.Add("i" + Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_Sort, Me.txtProjectName.Text)
                    objNewData.Add("i" + Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_Type, Me.rblHouseType.SelectedValue)

                    '保存信息
                    With New Xydc.Platform.BusinessFacade.systemCommon
                        If .doSaveData(strErrMsg, MyBase.UserId, MyBase.UserPassword, strTable, strWhere, True, objNewData, Me.m_objenumEditType) = False Then
                            GoTo errProc
                        End If
                    End With
...
errProc:
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                intStep = 2
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    objMessageProcess.doConfirmMessage(Me.popMessageObject, "提示：您确实准备删除选定的[1]条内容吗（是/否）？", strControlId, intStep)
                    Exit Try
                Else
                    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_ID)

                    strJJCD = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(intSelect), intColIndex)
                    strWhere = Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSEMATCHSORT_ID + "=" + strJJCD
                    ...
                    '删除处理
                    If objsystemCommon.doDeleteData(strErrMsg, MyBase.UserId, MyBase.UserPassword, strTable, strWhere, objOldData) = False Then
                        GoTo errProc
                    End If
...
errProc:
        ...
        Private Sub doSeekSort(ByVal strControlId As String)
            ...
            Try
                strWhere = ""
                If Me.txtSortHouse.Text <> "" Then
                    strWhere = strWhere + " c_name like  "
                    strWhere = strWhere + "'%"
                    strWhere = strWhere + Me.txtSortHouse.Text
                    strWhere = strWhere + "%'"

<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunshineData_WeekMatchHouse.aspx.vb" Inherits="Xydc.Platform.web.sunshineData_WeekMatchHouse" %>
		...
		<form id="frmGWDM_JJCD" method="post" runat="server">
			<asp:panel id="panelMain" Runat="server">
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>						
						 <TD class="title" align="center" colspan="3">周楼盘匹配<asp:LinkButton id="LinkButton1" Runat="server" Width="0px"></asp:LinkButton></TD>
					</TR>
					<TR>
						<TD width="5"></TD>
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											...
											<TR>
												<TD>
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 420px; CLIP: rect(0px 420px 300px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 300px">
														<asp:datagrid id="grdObjects" runat="server" runat="server" Width="400px" CssClass="labelGrid" 
                                                            ...
                                                            <Columns>	
																...
																<asp:ButtonColumn Visible="false"  DataTextField="MonitoringID" SortExpression="MonitoringID" HeaderText="MonitoringID" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="Region" SortExpression="Region" HeaderText="区域" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="Type" SortExpression="Type" HeaderText="类型" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="150px" DataTextField="BuildingName" SortExpression="BuildingName" HeaderText="项目名称" CommandName="Select">
																	<HeaderStyle Width="150px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="150px" DataTextField="SellingHouse" SortExpression="SellingHouse" HeaderText="在售组团" CommandName="Select">
																	<HeaderStyle Width="150px"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
															...
															<TD class="label" align="center">
																<TABLE cellSpacing="0" cellPadding="0" border="0">
																	...
																	<TR>
																		...
																		<TD class="label" align="left" width="60%"><asp:textbox id="txtRegion" Runat="server" Font-Size="12px" Font-Name="宋体" Columns="8" CssClass="textbox" ></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
																	<TR>
																		...
																		<TD class="label" align="left"><asp:textbox id="txtType" Runat="server" Font-Size="12px" Font-Name="宋体" Columns="24" CssClass="textbox"></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>		
																	<TR>
																	...
																	<TR>
																		<TD class="labelNotNull" align="right">在售组团：</TD>
																		<TD class="label" align="left"><asp:textbox id="txtProjectName" Runat="server" Font-Size="12px" Font-Name="宋体" Columns="24" CssClass="textbox"></asp:textbox><SPAN class="label" style="COLOR: red">*</SPAN></TD>
																	</TR>																																	
																	<TR>
																		<TD class="label" align="center" colSpan="2" height="2"></TD>
																	</TR>
									...
									<td align="left" valign="top" style="height:100%" >
						                ...
						                <TR>
									            <TD>
										            <DIV id="divHOUSEMATCH" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 440px; CLIP: rect(0px 440px 400px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 400px">
											            <asp:datagrid id="grdHOUSEMATCH" runat="server" runat="server" Width="400px" CssClass="labelGrid" 
                                                            ...
                                                            <Columns>	
													            ...
													            <asp:ButtonColumn ItemStyle-Width="120px" DataTextField="C_HOUSE" SortExpression="C_HOUSE" HeaderText="楼盘名称" CommandName="Select">

...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_buildingVerify
        ...
        Private Function getModuleData( _
            ...
            Try
                ...
                With New Xydc.Platform.BusinessFacade.systemSunshine
                    If .getSunshineHouseMatch(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objSunshineDataSet) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        If intStrPositon > 0 Then
                            Me.txtBuildingName.Text = Left(Me.txtProjectName.Text, intStrPositon - 1)
                        Else
                            Me.txtBuildingName.Text = Me.txtProjectName.Text
                        End If
                    End If
                Else
                    '编辑状态
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    '删除处理
                    If objsystemSunshine.doDeleteSunshineHouseMatch(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                        GoTo errProc
                    End If

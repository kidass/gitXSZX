<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="sunhineData_House_Sort.aspx.vb" Inherits="Xydc.Platform.web.sunhineData_House_Sort" %>
				...
				<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
					...
					<TR>
						...
						<TD align="center" style="BORDER-BOTTOM: #99cccc 2px solid">
							<TABLE cellSpacing="0" cellPadding="0" width="100%" border="0">
								<TR vAlign="middle" align="center" height="24">
							...
							<TABLE cellSpacing="0" cellPadding="0" border="0">
								...
								<TR>
									...
									<TD vAlign="top">
										<TABLE cellSpacing="0" cellPadding="0" border="0">
											<tr>
						                        <td class="label"  colspan="2" align="left" valign="middle">楼盘名称：                            
                                                    <asp:TextBox ID="txtSortHouse" Width="90" runat="server" Font-Size="12px" Font-Name="宋体"  Columns="12" CssClass="textbox"></asp:TextBox>                                                                         
                                                    <asp:LinkButton ID="lnkSearchSort" runat="server" Font-Name="宋体" Font-Size="12px">查找</asp:LinkButton>
                                                </td>  
						                    </tr>
											<TR>
												<TD>
													<DIV id="divObjects" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 230px; CLIP: rect(0px 230px 320px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 320px">
														<asp:datagrid id="grdObjects" runat="server"  Width="210px" CssClass="labelGrid" 
                                                            ...
                                                            <Columns>	
																...
																<asp:ButtonColumn Visible="false"  DataTextField="I_ID" SortExpression="I_ID" HeaderText="I_ID" CommandName="Select">
																	<HeaderStyle Width="0px"></HeaderStyle>
																</asp:ButtonColumn>																
																<asp:ButtonColumn ItemStyle-Width="150px" DataTextField="C_NAME" SortExpression="C_NAME" HeaderText="项目名称" CommandName="Select">
																	<HeaderStyle Width="150px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="I_Sort" SortExpression="I_Sort" HeaderText="序号" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
																<asp:ButtonColumn ItemStyle-Width="60px" DataTextField="S_Type" SortExpression="S_Type" HeaderText="类型" CommandName="Select">
																	<HeaderStyle Width="60px"></HeaderStyle>
																</asp:ButtonColumn>
															</Columns>
											...
											<TR>
												<TD class="label" align="center" style="BORDER-RIGHT: #99cccc 1px solid; BORDER-TOP: #99cccc 1px solid; BORDER-LEFT: #99cccc 1px solid; BORDER-BOTTOM: #99cccc 1px solid">
													<TABLE cellSpacing="0" cellPadding="0" border="0">
														...
														<TR>
															<TD class="label" align="center" height="20"><B>排序</B></TD>
														</TR>
														<TR>
															<TD class="label" align="center">
																<TABLE cellSpacing="0" cellPadding="0" border="0">
																    <tr>
                                                                        ...
                                                                        <td>
                                                                             <asp:RadioButtonList id="rblHouseType" Runat="server" CssClass="textbox" RepeatColumns="3" RepeatDirection="Horizontal" RepeatLayout="Table">
				                                                                <asp:ListItem Value="1" >商业</asp:ListItem>
				                                                                <asp:ListItem Value="2" Selected="True">住宅</asp:ListItem>
																	...
																	<TR>
																		<TD class="labelNotNull" align="right">排序：</TD>
						                ...
						                <TR>
									            <TD>
										            <DIV id="divHOUSEMATCH" style="BORDER-RIGHT: #99cccc 1px solid; TABLE-LAYOUT: fixed; BORDER-TOP: #99cccc 1px solid; OVERFLOW: auto; BORDER-LEFT: #99cccc 1px solid; WIDTH: 440px; CLIP: rect(0px 440px 400px 0px); BORDER-BOTTOM: #99cccc 1px solid; HEIGHT: 400px">
											            <asp:datagrid id="grdHOUSEMATCH" runat="server"  Width="400px" CssClass="labelGrid" 

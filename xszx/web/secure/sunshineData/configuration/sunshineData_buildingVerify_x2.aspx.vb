...
Namespace Xydc.Platform.web
    ...
    Partial Public Class sunshineData_buildingVerify_x2
            ...
            Try
                If blnEditMode = False Then
                    ...
                    If Me.grdObjects.Items.Count < 1 Then
                        ...
                        Me.txtProjectAddress.Text = ""
                        'Me.txtMatchDate.Text = ""
                    ...
                    Else
                        ...
                        'intColIndex(5) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_TIME)
                        Me.txtRegion.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtProjectName.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(2))
                        Me.txtProjectId.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(3))
                        Me.txtProjectAddress.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(4))
                        'Me.txtMatchDate.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(5))

                        '获取（的位置（对中英文的两种输入法搜索）
                        Dim intStrPositon As Integer
                        Dim intStrPositon_0 As Integer
                        intStrPositon = InStr(Me.txtProjectName.Text, "（")
                        intStrPositon_0 = InStr(Me.txtProjectName.Text, "(")
                        ...
                        If intStrPositon > 0 Then
                            Me.txtBuildingName.Text = Left(Me.txtProjectName.Text, intStrPositon - 1).Trim
                        Else
                            Me.txtBuildingName.Text = Me.txtProjectName.Text.Trim
                        End If
                    End If
                Else
                    '编辑状态
                ...
                With New Xydc.Platform.web.ControlProcess
                    .doEnabledControl(Me.txtRegion, blnEditMode)
                    .doEnabledControl(Me.txtBuildingName, blnEditMode)
                    .doEnabledControl(Me.txtProjectName, blnEditMode)
                    .doEnabledControl(Me.txtProjectId, blnEditMode)
                    .doEnabledControl(Me.txtProjectAddress, blnEditMode)
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        'intColIndex(6) = objDataGridProcess.getDataGridColumnIndex(Me.grdHOUSEMATCH, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_TIME)

                        Me.txtRegion.Text = objDataGridProcess.getDataGridCellValue(Me.grdHOUSEMATCH.Items(Me.grdHOUSEMATCH.SelectedIndex), intColIndex(0))
                        Me.txtProjectName.Text = objDataGridProcess.getDataGridCellValue(Me.grdHOUSEMATCH.Items(Me.grdHOUSEMATCH.SelectedIndex), intColIndex(2))
                        ...
                        Me.txtProjectId.Text = objDataGridProcess.getDataGridCellValue(Me.grdHOUSEMATCH.Items(Me.grdHOUSEMATCH.SelectedIndex), intColIndex(3))
                        Me.txtProjectAddress.Text = objDataGridProcess.getDataGridCellValue(Me.grdHOUSEMATCH.Items(Me.grdHOUSEMATCH.SelectedIndex), intColIndex(4))
                        'Me.txtMatchDate.Text = objDataGridProcess.getDataGridCellValue(Me.grdHOUSEMATCH.Items(Me.grdHOUSEMATCH.SelectedIndex), intColIndex(6))
...
errProc:
        ...
        Private Function showModuleData( _
            ...
            Try
                ...
                '日楼盘数据生成屏蔽 2013-08-07
                'Me.lnkMLExecProcedure.Enabled = (Not blnEditMode And Me.m_blnPrevilegeParams(4))
                Me.lnkMLDeleteHouse.Enabled = (Not blnEditMode And Me.m_blnPrevilegeParams(4))
                Me.lnkMLBulidHouse.Enabled = (Not blnEditMode And Me.m_blnPrevilegeParams(4))
                Me.txtDeleteHouse.Enabled = (Not blnEditMode And Me.m_blnPrevilegeParams(4))
                Me.txtBuildHouse.Enabled = (Not blnEditMode And Me.m_blnPrevilegeParams(4))
                'Me.txtDate.Enabled = (Not blnEditMode And Me.m_blnPrevilegeParams(4))
            ...
            If Me.IsPostBack = False Then
                Try
                    ...
                    With New Xydc.Platform.web.ControlProcess
                        ...
                        .doTranslateKey(Me.txtRegion)
                        .doTranslateKey(Me.txtProjectName)
                        .doTranslateKey(Me.txtBuildingName)
                        .doTranslateKey(Me.txtProjectId)
                        .doTranslateKey(Me.txtProjectAddress)
                    End With
            ...
            If Me.IsPostBack = False Then
                If Me.m_blnSaveScence = False Then
                    With New Xydc.Platform.DataAccess.dacSystemOperate
                        If .doSaveVisitLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, "sunshineData_buildingVerify_x2.aspx", "楼盘匹配检查") = False Then
                            GoTo errProc
                        End If
                    End With
                End If
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                '获取新信息
                'If Me.txtMatchDate.Text = "" Then
                '    Me.txtMatchDate.Text = DateTime.Today.ToShortDateString
                'End If

                Dim objNewData As New System.Collections.Specialized.NameValueCollection
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XZQY, Me.txtRegion.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_HOUSE, Me.txtBuildingName.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_NAME, Me.txtProjectName.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_ID, Me.txtProjectId.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_ADDRESS, Me.txtProjectAddress.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_TYPE, Me.rblHouseType.SelectedValue)
                'objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_XM_TIME, Me.txtMatchDate.Text)
                ...
                Select Case Me.m_objenumEditType
                    ...
                    Case Else
                        ...
                        With New Xydc.Platform.web.DataGridProcess
                            intPos = .getRecordPosition(Me.grdHOUSEMATCH.SelectedIndex, Me.grdHOUSEMATCH.CurrentPageIndex, Me.grdHOUSEMATCH.PageSize)
                        End With
                        With Me.m_objSunshineDataSet_HOUSEMATCH.Tables(strTable)
                ...
                '保存信息
                With New Xydc.Platform.BusinessFacade.systemSunshine_x2
                    If .doSaveSunshineHouseMatch(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Xydc.Platform.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[楼盘匹配]字典中增加了[" + Me.txtRegion.Text + "]！")
                    Case Else
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]修改了[楼盘匹配]字典！")
                End Select
                    ...
                    Select Case Me.m_objenumEditType
                        Case Xydc.Platform.Common.Utilities.PulicParameters.enumEditType.eAddNew
                            If .doSaveOperateLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Xydc.Platform.Common.Data.LogData.OperateType_insert, _
                               Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_HOUSE_MATCH_XMID, "添加了" + Me.txtRegion.Text) = False Then
                                GoTo errProc
                            End If
                        Case Else
                            If .doSaveOperateLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Xydc.Platform.Common.Data.LogData.OperateType_insert, _
                               Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_HOUSE_MATCH_XMID, "修改了" + Me.txtRegion.Text) = False Then
                                GoTo errProc
                            End If
                    End Select
                End With
...
errProc:
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                Dim i As Integer
                intRows = Me.grdHOUSEMATCH.Items.Count
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    Dim intPos As Integer
                    intSelect = Me.grdHOUSEMATCH.SelectedIndex
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdHOUSEMATCH, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_HOUSE_MATCH_ID)

                    strJJCD = objDataGridProcess.getDataGridCellValue(Me.grdHOUSEMATCH.Items(intSelect), intColIndex)

                    '获取要删除的数据
                    intPos = objDataGridProcess.getRecordPosition(intSelect, Me.grdHOUSEMATCH.CurrentPageIndex, Me.grdHOUSEMATCH.PageSize)
                    objOldData = Nothing
                    With Me.m_objSunshineDataSet_HOUSEMATCH.Tables(strTable)
                        objOldData = .DefaultView.Item(intPos).Row
                    End With
                    ...
                    '删除处理
                    If objsystemSunshine_x2.doDeleteSunshineHouseMatch(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                        GoTo errProc
                    End If

                    '记录审计日志
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[楼盘匹配]字典中删除了[" + strJJCD + "]！")
                    ...
                    With New Xydc.Platform.DataAccess.dacSystemOperate
                        If .doSaveOperateLogData(strErrMsg, MyBase.UserId, MyBase.UserPassword, Request.UserHostAddress, Request.UserHostName, Xydc.Platform.Common.Data.LogData.OperateType_delete, _
                                   Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_HOUSE_MATCH_XMID, "删除了" + strJJCD) = False Then
                            GoTo errProc
                        End If
                    End With
...
errProc:
        ...
        Private Sub doExecProcedure(ByVal strControlId As String)
            ...
            Try
                ...
                updateDate = CType(Me.txtDate.Text, System.DateTime)

                If updateDate = today Then
                    strErrMsg = "今天的楼盘数据已存在，无须更新！"
                    objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
                ...
                '查询返回楼盘匹配记录数
                With New Xydc.Platform.BusinessFacade.systemSunshine_x2
                    If .getDayHouseMatchCount(strErrMsg, MyBase.UserId, MyBase.UserPassword, intCount) = False Then
                        GoTo errProc
                    End If
                End With

                If intCount > 0 Then
                    strErrMsg = "警告：请先完成楼盘资料匹配，再生成楼盘数据！"
                    objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
                    GoTo errProc
                    '询问
                    'intStep = 1
                    'If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    '    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：楼盘资料尚未匹配完整，您确定要生成日楼盘数据（是/否）？", strControlId, intStep)
                    '    Exit Try
                    'Else
                    '    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                    'End If
                Else
                    ...
                    intStep = 1
                    If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                        objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定要生成楼盘数据（是/否）？", strControlId, intStep)
                        Exit Try
                    Else
                        objMessageProcess.doResetPopMessage(Me.popMessageObject)
                    End If
                ...
                'intStep = 1
                'If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                '    objMessageProcess.doConfirmMessage(Me.popMessageObject, "警告：您确定要生成日楼盘数据（是/否）？", strControlId, intStep)
                '    Exit Try
                'Else
                '    objMessageProcess.doResetPopMessage(Me.popMessageObject)
                'End If
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    '执行日楼盘数据存储过程
                    If objsystemSunshine.doExecProcedureHouseData(strErrMsg, MyBase.UserId, MyBase.UserPassword) = False Then
                        GoTo errProc
                    End If
                ...
                strErrMsg = "楼盘数据已更新至" + dayHouseDataTime.ToLongDateString
                objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
...
errProc:
        ...
        Private Sub doDeleteHouseDataProcedure(ByVal strControlId As String)
            ...
            Try
                ...
                If txtDeleteHouse.Text = "" Then
                    strErrMsg = "错误：请输入要删除的楼盘名称！"
                    GoTo errProc
                End If


                '查询是否存在要删除的楼盘名称记录，返回记录数
                With New Xydc.Platform.BusinessFacade.systemSunshine_x2
                    If .getDayHouseDetailCount(strErrMsg, MyBase.UserId, MyBase.UserPassword, txtDeleteHouse.Text, intCount) = False Then
                        GoTo errProc
                    End If
                End With
                If intCount = 0 Then
                    strErrMsg = "警告：楼盘数据中不存在该楼盘名称的记录，请确认楼盘名称后再进行删除！"
                    objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
                    GoTo errProc
                End If
                ...
                '执行"删除单个楼盘日数据"存储过程
                If objsystemSunshine.doDeleteHouseDataProcedure(strErrMsg, MyBase.UserId, MyBase.UserPassword, txtDeleteHouse.Text) = False Then
                    GoTo errProc
                End If

                strErrMsg = "已成功删除 '" + txtDeleteHouse.Text + "'楼盘数据，请重新生成该楼盘数据！"
                objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
...
errProc:
        ...
        Private Sub doExecHouseDataProcedure(ByVal strControlId As String)
            ...
            Try
                ...
                If txtBuildHouse.Text = "" Then
                    strErrMsg = "错误：请输入要生成的楼盘名称！"
                    GoTo errProc
                End If
                ...
                '查询返回楼盘匹配记录数
                With New Xydc.Platform.BusinessFacade.systemSunshine_x2
                    If .getHouseMatchXmidCount(strErrMsg, MyBase.UserId, MyBase.UserPassword, txtBuildHouse.Text, intCount) = False Then
                        GoTo errProc
                    End If
                End With
                If intCount = 0 Then
                    strErrMsg = "警告：楼盘匹配表中不存在该楼盘名称的记录，请确认楼盘名称后再生成楼盘数据！"
                    objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
                    GoTo errProc
                End If
                ...
                '执行"生成单个楼盘日数据"存储过程
                If objsystemSunshine.doExecHouseDataProcedure(strErrMsg, MyBase.UserId, MyBase.UserPassword, txtBuildHouse.Text) = False Then
                    GoTo errProc
                End If

                strErrMsg = "已成功生成 '" + txtBuildHouse.Text + "'楼盘数据！"
                objMessageProcess.doAlertMessage(Me.popMessageObject, strErrMsg)
...
errProc:
        ...
        Protected Sub lnkMLExecProcedure_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkMLExecProcedure.Click
            Me.doExecProcedure("lnkMLExecProcedure")
        End Sub

        Protected Sub lnkMLDeleteHouse_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkMLDeleteHouse.Click
            Me.doDeleteHouseDataProcedure("lnkMLDeleteHouse")
        End Sub

        Protected Sub lnkMLBulidHouse_Click(ByVal sender As Object, ByVal e As EventArgs) Handles lnkMLBulidHouse.Click
            Me.doExecHouseDataProcedure("lnkMLBulidHouse")
        End Sub
    End Class
End Namespace
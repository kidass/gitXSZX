...
Namespace Xydc.Platform.web
    ...
    '----------------------------------------------------------------
    ' 命名空间：Xydc.Platform
    ' 类名    ：sunshineData_WeekMatchHouse
    ' 
    ' 调用性质：
    '   独立运行
    '
    ...
    '   　“周楼盘匹配”处理模块
    '----------------------------------------------------------------
    Partial Public Class sunshineData_WeekMatchHouse
...
errProc:
        ...
        Private Function getModuleData( _
            ...
            Dim strTable As String = Xydc.Platform.Common.Data.SunshineData.TABLE_Sunshine_B_WeekMonitoringHouse
            ...
            Try
                ...
                With New Xydc.Platform.BusinessFacade.systemSunshine
                    If .getWeekMonitoringHouse(strErrMsg, MyBase.UserId, MyBase.UserPassword, strWhere, Me.m_objSunshineDataSet) = False Then
                        GoTo errProc
                    End If
                End With
            ...
            Try
                If blnEditMode = False Then
                    ...
                    Else
                        ...
                        intColIndex(0) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_Region)
                        intColIndex(1) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_Type)
                        intColIndex(2) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_NAME)
                        intColIndex(3) = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_SellingHouse)
                        Me.txtRegion.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(0))
                        Me.txtType.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(1))
                        Me.txtBuildingName.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(2))
                        Me.txtProjectName.Text = objDataGridProcess.getDataGridCellValue(Me.grdObjects.Items(Me.grdObjects.SelectedIndex), intColIndex(3))
                    End If
                Else
                    '编辑状态
                    '自动恢复数据
                ...
                With New Xydc.Platform.web.ControlProcess
                    ...
                    .doEnabledControl(Me.txtType, blnEditMode)
...
errProc:
        ...
        Private Sub doSave(ByVal strControlId As String)
            ...
            Try
                ...
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_Region, Me.txtRegion.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_NAME, Me.txtBuildingName.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_SellingHouse, Me.txtProjectName.Text)
                objNewData.Add(Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_Type, Me.txtType.Text)
                ...
                '保存信息
                With New Xydc.Platform.BusinessFacade.systemSunshine
                    If .doSaveSunshineWeekMonitoringHouse(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData, objNewData, Me.m_objenumEditType) = False Then
                        GoTo errProc
                    End If
                End With
                ...
                Select Case Me.m_objenumEditType
                    Case Xydc.Platform.Common.Utilities.PulicParameters.enumEditType.eAddNew
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[周楼盘匹配]字典中增加了[" + Me.txtBuildingName.Text + "]！")
                    Case Else
                        Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]修改了[周楼盘匹配]字典！")
                End Select
        ...
        Private Sub doDelete(ByVal strControlId As String)
            ...
            Try
                ...
                If objMessageProcess.isExecuteCode(Request, Me.popMessageObject.UniqueID, intStep) = True Then
                    ...
                    intColIndex = objDataGridProcess.getDataGridColumnIndex(Me.grdObjects, Xydc.Platform.Common.Data.SunshineData.FIELD_Sunshine_B_WeekMonitoringHouse_ID)
                    ...
                    '删除处理
                    If objsystemSunshine.doDeleteSunshineWeekMonitoringHouse(strErrMsg, MyBase.UserId, MyBase.UserPassword, objOldData) = False Then
                        GoTo errProc
                    End If

                    '记录审计日志
                    Xydc.Platform.SystemFramework.ApplicationLog.WriteAuditPZInfo(Request.UserHostAddress, Request.UserHostName, "[" + MyBase.UserId + "]在[周楼盘匹配]字典中删除了[" + strJJCD + "]！")

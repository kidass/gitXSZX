<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="lockuser.aspx.vb" Inherits="Xydc.Platform.web.lockuser" %>
...
<HTML>
	...
	<body bottomMargin="0" leftMargin="0" topMargin="0" rightMargin="0" style="FILTER:progid:DXImageTransform.Microsoft.Gradient(GradientType=0, StartColorStr='#006699', EndColorStr='#6699CC')">
		<form id="frmLockAccount" method="post" runat="server" language="javascript">
			<asp:panel id="panelLogin" Runat="server">
				<TABLE id="tabErrMain" height="98%" cellSpacing="0" cellPadding="0" width="100%" border="0">
					<TR>
						<TD vAlign="middle" align="center" width="100%">系统正在锁定用户，请稍侯......</TD>
					</TR>
				</TABLE>
			</asp:panel>

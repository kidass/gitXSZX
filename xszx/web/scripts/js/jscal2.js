...
Calendar = (function() {
    ...
    function aa(P, at, D) {
        ...
        if (at != 0) {
            ...
            switch (at) {
            case "-Y":
            case - 2 : ar.setFullYear(ar.getFullYear() - 1);
                break;
            case "+Y":
            case 2:
                ...
                break;
            case "-M":
            case - 1 : ar.setMonth(ar.getMonth() - 1);
                break;
            case "+M":
            case 1:
    ...
    function R() {
        ...
        P = this.selection;
        if (D) {
            var ar = P.print(this.dateFormat); (/input|textarea/i.test(D.tagName)) ? D.value = ar: D.innerHTML = ar
        }
    ...
    function aq(ar, P) {
        ...
        selectRange: function(au, at) {
            ...
            try {
                m(new y.Selection([[au, at]], y.SEL_MULTIPLE, ad).getDates(), v(function(av) {

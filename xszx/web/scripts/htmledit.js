...
//  Usage       : editor_generate("textarea_id",userConfig);
...
function editor_generate(objname, userConfig) {
	...
	// build editor
	var editor = '<span id="_editor_toolbar"><table id="_editor_toolbar01" border=0 cellspacing=0 cellpadding=0 bgcolor="buttonface" style="padding: 1 0 0 2" width=' + config.width + ' unselectable="on"><tr><td>\n'
				+ toolbar
				+ '</td></tr></table>\n'
				+ '</td></tr></table></span>\n'
...
function editor_action(button_id) {
	...
	// fgColor and bgColor
		...
		var newcolor = showModalDialog(_editor_url + "popups/select_color.html", oldcolor, "resizable: yes; help: no; status: no; scroll: yes;");
	...
	// commandID and pass it to execCommand().   See http://msdn.microsoft.com/workshop/author/dhtml/reference/commandids.asp
		...
		// insert image
			...
			showModalDialog(_editor_url + "popups/insert_image.html", editdoc, "resizable: yes; help: no; status: no; scroll: yes; ");
		}
